...
class DiscoverController extends Controller
{
    ...
    public function index()
    {
        if (\Auth::user()->type == 'super admin') {
            ...
            return view('landingpage.discover.index', compact('settings', 'discover_of_features'));
        } else {
    ...
    {
        return view('landingpage.discover.create');
    }
    ...
    {
        return view('landingpage.discover.show');
    }
    ...
    {
        return view('landingpage.discover.edit');
    }
    ...
    public function discover_edit($key)
    {
        ...
        return view('landingpage.discover.edit', compact('discover', 'key'));
    }
