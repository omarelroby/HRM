...
class ScreenshotsController extends Controller
{
    ...
    public function index()
    {
        if (\Auth::user()->type == 'super admin') {
            $settings = \App\Models\LandingPageSetting::settings();
            $screenshots = json_decode($settings['screenshots'], true) ?? [];
            return view('landingpage.screenshots.index',compact('settings','screenshots'));
        } else {
    ...
    {
        return view('landingpage.screenshots.create');
    }
    ...
    {
        return view('landingpage.screenshots.show');
    }
    ...
    {
        return view('landingpage.screenshots.edit');
    }
    ...
    public function screenshots_edit($key){
        ...
        return view('landingpage.screenshots.edit', compact('screenshot','key'));
    }
