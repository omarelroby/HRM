...
class TestimonialsController extends Controller
{
    ...
    public function index()
    {
        if (\Auth::user()->type == 'super admin') {
            ...
            return view('landingpage.testimonials.index', compact('settings', 'testimonials'));
        } else {
    ...
    {
        return view('landingpage.testimonials.create');
    }
    ...
    public function testimonials_edit($key)
    {
        ...
        return view('landingpage.testimonials.edit', compact('testimonial', 'key'));
    }
