...
// cancel button js
function cancelButtonCss() {
    document.querySelectorAll('.modal-footer input[type="button"]').forEach(button => {
    ...
    document.querySelectorAll('.modal-footer button[data-bs-dismiss="modal"]').forEach(button => {
