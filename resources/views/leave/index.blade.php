    ...
    <div class="all-button-box row d-flex justify-content-end">
        @can('Create Leave')
            <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-6">
                <a href="#" data-url="{{ route('leave.create') }}" class="btn btn-primary btn-icon-only width-auto"
        ...
        @endcan
        <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-6">
            <a href="{{ route('leave.export') }}" class="btn btn-primary btn-icon-only width-auto">
