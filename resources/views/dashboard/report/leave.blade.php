    ...
    <div id="printableArea" class="mt-4">
        <div class="row d-flex justify-content-end">
            ...
            <div class="col-auto my-custom">
                <a href="#" class="apply-btn btn btn-primary mt-4" onclick="document.getElementById('report_leave').submit(); return false;" data-toggle="tooltip" data-original-title="{{__('apply')}}">
                    <span class="btn-inner--icon"><i class="fa fa-search"></i></span>
                </a>
                <a href="{{route('report.leave')}}" class="reset-btn btn btn-danger mt-4" data-toggle="tooltip" data-original-title="{{__('Reset')}}">
                        ...
                        <div class="table-responsive">
                            ...
                            @foreach($leaves as $leave)
                                <tr>
                                    ...
                                    <td>
                                        <div class="m-view-btn btn btn-primary">{{$leave['approved']}}
                                            <a href="#"
                                    ...
                                    <td>
                                        <div class="m-view-btn btn btn-danger">{{$leave['reject']}}
                                            <a href="#"
                                               style="color: white; text-decoration: underline;"
                                    ...
                                    <td>
                                        <div class="m-view-btn btn btn-success">{{$leave['pending']}}
                                            <a href="#"
                                               style="color: white; text-decoration: underline;"
