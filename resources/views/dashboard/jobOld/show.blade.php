    ...
    <div class="all-button-box row d-flex justify-content-end">
        @can('Edit Job')
            <div class="col-xl-2 col-lg-2 col-md-4 col-sm-6 col-6">
                <a href="{{ route('job.edit',$job->id) }}" data-title="{{__('Edit Job')}}" class="btn btn-primary btn-icon-only width-auto" data-toggle="tooltip" data-original-title="{{__('Edit')}}"><i class="fa fa-edit"></i></a>
            </div>
        @endcan
