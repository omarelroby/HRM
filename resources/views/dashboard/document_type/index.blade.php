    ...
    <div class="row">
        <div class="d-flex justify-content-end mb-3">
                ...
                <a href="#" data-bs-toggle="modal" data-bs-target="#addTrainingModal" class="btn btn-primary btn-lg">
                    <i class="fas fa-plus"></i> {{ __('Create New Document Type') }}
                </a>
        ...
        <div class="col-lg-12">
            <div class="card shadow-sm">
                <div class="card-header text-white">
                    <h5 class="card-title mb-0">{{ __('Documents Types') }}</h5>
                </div>
                                ...
                                @foreach ($document_types as $type)
                                    <tr>
                                        ...
                                        <td class="text-right action-btns">
                                                ...
                                                <a href="{{ route('document-type.edit',$type->id) }}"
                                                ...
                                                <form method="POST" action="{{ route('document-type.destroy', $type->id) }}" class="d-inline" onsubmit="return confirm('{{ __('Are You Sure?') }}\n{{ __('This action cannot be undone. Do you want to continue?') }}');">
                                                    @csrf
                                                    @method('DELETE')
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-header text-white">
                <h5 class="modal-title" id="addTrainingModalLabel">{{ __('Add Document Type') }}</h5>
