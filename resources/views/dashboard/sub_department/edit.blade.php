    ...
    <div class="row">
        ...
        <div class="col-lg-12">
            <div class="card shadow-sm">
                ...
                <!-- Card Body -->
                <div class="card-body">
                    {{Form::model($subDepartment,array('route' => array('sub-department.update', $subDepartment->id), 'method' => 'PUT')) }}
                    <div class="row ">
                        <div class="col-12">
                            <div class="form-group">
                                {{Form::label('department_id',__('Branch'))}}
                                {{Form::select('department_id',$departments,null,array('class'=>'form-control select2 ','placeholder'=>__('select Branch')))}}
                            </div>
                        </div>
{{--
                        <div class="col-md-12">
