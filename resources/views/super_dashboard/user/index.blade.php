                ...
                @foreach ($users as $user)
                    <div class="col-xl-3">
                        <div class="card  text-center">
                            ...
                            <div class="card-body">
                                <div class="avatar">
                                    <a href="{{$user->avatar?asset(Storage::url($user->avatar)):asset(Storage::url('uploads/avatar/company.png'))}}"
                                       target="_blank">
                                        <img src="{{$user->avatar?asset(Storage::url($user->avatar)):asset(Storage::url('uploads/avatar/company.png'))}}"
