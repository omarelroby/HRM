...
<div class="modal-body">
    ...
    <div class="row">
        ...
        <div class="col-lg-2 col-xl-2 col-md-2">
            <div class="form-check form-switch ml-1">
                <input type="checkbox" class="form-check-input" id="cust-darklayout1" name="login" />
                <label class="form-check-label f-w-600 pl-1" for="cust-darklayout1">{{ __('Login') }}</label>
            </div>
        </div>
