...
@section('action-button')
    @can('Create Holiday')
        <div class="all-button-box row d-flex justify-content-end mt-2">
            ...
            <div class="col-auto">
                <a href="{{ route('holiday.index') }}" class="action-btn btn btn-info mt-4" data-toggle="tooltip" data-original-title="{{__('List View')}}">
...
@section('content')
    <div class="row d-flex justify-content-end">
        ...
        <div class="col-auto my-custom">
            ...
            <a href="{{route('holiday.calender')}}" class="reset-btn btn btn-danger mt-4" data-toggle="tooltip" data-original-title="{{__('Reset')}}">
