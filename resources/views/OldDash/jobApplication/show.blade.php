                ...
                <div class="card-body">
                    ...
                    <div class="py-2 my-4 border-top ">
                        ...
                        <div class="col-12 text-right">
                            <a href="#" data-url="{{route('job.on.board.create', $jobApplication->id)}}" data-ajax-popup="true" class="btn btn-primary btn-icon-only width-auto">  {{__('Add to Job OnBoard')}}</a>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col text-right">
                            @can('Create Interview Schedule')
                                <a href="#" data-url="{{ route('interview-schedule.create',$jobApplication->id) }}" class="btn btn-primary btn-icon-only width-auto" data-ajax-popup="true" data-title="{{__('Create New Interview Schedule')}}">
                                    ...
                                    @can('Delete Job Application Note')
                                        @if($note->note_created==\Auth::user()->id)
                                            <div class="col-auto text-right">
                                                <a class="delete-icon btn btn-danger" href="#" data-confirm="Are You Sure?|This action can not be undone. Do you want to continue?" data-confirm-yes="document.getElementById('delete-form-{{$note->id}}').submit();"> <i class="fas fa-trash"></i></a>
