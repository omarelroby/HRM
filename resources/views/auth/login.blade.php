...
<div class="wrapper">
    ...
    <div class="form-box login">
        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            <div class="input-box animation" style="--i:1; --j:22;">
                <input type="email" name="email" placeholder="{{ __('Email') }}" value="{{ old('email') }}" autofocus
                       required>
            ...
            <button class="btn animation" type="submit" style="--i:3; --j:24;">{{ __('Login') }}</button>
    ...
    <div class="info-text login">
        ...
        <p class="animation" style="--i:1; --j:21;">We're happy to have you with us back again! If you need anything,
    ...
    <div class="form-box register">
        ...
        <form method="POST" action="{{ route('register') }}" >
            ...
            <div class="input-box animation" style="--i:18; --j:1;">
                <input type="text" class="name" placeholder="{{__('Name')}}" autofocus required>
                <label>{{__('Name')}}</label>
                <i class='bx bxs-user'></i>
            </div>
    ...
    <div class="info-text register">
        ...
        <p class="animation" style="--i:18; --j:1">We're delighted to have you here. If you need any assistance, feel
            free to reach out</p>
    </div>
</div>
