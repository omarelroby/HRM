                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex align-items-center justify-content-end">
                            ...
                            <div class="col-auto float-end ms-2 mt-4">
                                ...
                                <a href="{{ route('report.leave') }}" class="btn btn-sm btn-danger "
                        ...
                        <tbody>
                            @foreach ($leaves as $leave)
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn btn-sm btn-info badge">{{ $leave['approved'] }}
                                    ...
                                    <td>
                                        <div class="btn btn-sm btn-danger badge">{{ $leave['reject'] }}
                                            <a href="#" class="text-white"
                                    ...
                                    <td>
                                        <div class="m-view-btn btn btn-sm btn-warning badge">
                                            {{ $leave['pending'] }}
                                            <a href="#" class="text-white"
