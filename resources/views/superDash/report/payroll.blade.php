                            ...
                            <div class="col-xl-10">
                                <div class="row">
                                    ...
                                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                        ...
                                        <div class="btn-box department_div" id="department_id">
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-4 col-lg-3 col-xl-3">
                    <div class="card p-4 mb-4">
                        ...
                        <h7 class="report-text mb-0">{{ \Auth::user()->priceFormat($filterData['totalBasicSalary']) }}
                        </h7>
                    </div>
                </div>
                <div class="col-xs-12 col-sm-12 col-md-4 col-lg-3 col-xl-3">
                ...
                <div class="col-xs-12 col-sm-12 col-md-4 col-lg-3 col-xl-3">
                    <div class="card p-4 mb-4">
                        ...
                        <h7 class="report-text mb-0">
                            {{ \Auth::user()->priceFormat($filterData['totalSaturationDeduction']) }}</h7>
                    </div>
                </div>
                <div class="col-xs-12 col-sm-12 col-md-4 col-lg-3 col-xl-3">
                    <div class="card p-4 mb-4">
                        <h6 class="report-text gray-text mb-0">{{ __('Total Other Payment') }} :</h6>
                        <h7 class="report-text mb-0">{{ \Auth::user()->priceFormat($filterData['totalOtherPayment']) }}
                        </h7>
                    </div>
                </div>
                <div class="col-xs-12 col-sm-12 col-md-4 col-lg-3 col-xl-3">
                                ...
                                @foreach ($payslips as $payslip)
                                    <tr>
                                        <td><a href="{{ route('employee.show', \Illuminate\Support\Facades\Crypt::encrypt($payslip->employee_id)) }}"
                                                ...
                                                {{ !empty($payslip->employees) ? \Auth::user()->employeeIdFormat($payslip->employees->employee_id) : '' }}</a>
                                        </td>
                                        ...
                                        <td>
                                            @if ($payslip->status == 0)
                                                <div class="badge bg-danger p-2 px-3 badge"><a href="#"
                                                        class="text-white">{{ __('UnPaid') }}</a></div>
                                            @else
                                                <div class="badge bg-success p-2 px-3 badge"><a href="#"
