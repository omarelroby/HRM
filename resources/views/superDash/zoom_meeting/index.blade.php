                                            ...
                                            <div class="user-group">
                                                @foreach ($ZoomMeeting->users($ZoomMeeting->user_id) as $projectUser)
                                                    <img alt="image" data-bs-toggle="tooltip" data-bs-placement="top"
                                                        ...
                                                        @if ($projectUser->avatar) src="{{ $logo . '/' . $projectUser->avatar }}" @else src="{{ $logo . 'avatar.png' }}" @endif
                                        ...
                                        <td>
                                            @if ($ZoomMeeting->checkDateTime())
                                                @if ($ZoomMeeting->status == 'waiting')
                                                    <span
                                                        class="badge bg-info p-2 px-3 ">{{ ucfirst($ZoomMeeting->status) }}</span>
                                                @else
                                                    <span
                                                        class="badge bg-success p-2 px-3 ">{{ ucfirst($ZoomMeeting->status) }}</span>
                                                @endif
                                            @else
                                                <span class="badge bg-danger p-2 px-3 ">{{ __('End') }}</span>
                                            @endif
