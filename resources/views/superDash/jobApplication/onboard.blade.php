                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if ($job->status == 'pending')
                                            <span
                                                class="badge bg-warning p-2 px-3 ">{{ \App\Models\JobOnBoard::$status[$job->status] }}</span>
                                        @elseif($job->status == 'cancel')
                                            <span
                                                class="badge bg-danger p-2 px-3 ">{{ \App\models\JobOnBoard::$status[$job->status] }}</span>
                                        @else
                                            <span
                                                class="badge bg-success p-2 px-3 ">{{ \App\models\JobOnBoard::$status[$job->status] }}</span>
                                        @endif
                                    </td>
