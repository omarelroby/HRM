...
@section('action-button')
    <div class="row d-flex justify-content-end">
        ...
        <div class="col-auto my-custom">
            <a href="#" class="apply-btn btn btn-primary mt-4" onclick="document.getElementById('report_acc_filter').submit(); return false;" data-toggle="tooltip" data-original-title="{{__('apply')}}">
                <span class="btn-inner--icon"><i class="fa fa-search"></i></span>
            </a>
            <a href="{{route('report.account.statement')}}" class="reset-btn btn btn-danger mt-4" data-toggle="tooltip" data-original-title="{{__('Reset')}}">
    ...
    {{--                <a href="#" class="btn btn-primary btn-icon-only width-auto" onclick="document.getElementById('report_acc_filter').submit(); return false;">--}}
    ...
    {{--        <div class="col-xl-2 col-lg-2 col-md-4 col-sm-6 col-6">--}}
    {{--            <div class="all-button-box">--}}
    {{--                <a href="{{route('report.account.statement')}}" class="btn btn-primary btn-icon-only bg-red width-auto">--}}
    ...
    {{--            <div class="all-button-box">--}}
    {{--                <a href="#" class="btn btn-primary btn-icon-only bg-yellow width-auto" onclick="saveAsPDF()">--}}
