...
Route::get('/get-department-data/{id}', [HomeController::class, 'getlanguvage'])->name('home.getlanguvage');
...
Route::resource('employee_shifts', 'ShiftController')->middleware(
    [
        'auth',
        'XSS',
    ]
...
Route::resource('salary_setting', 'SallerySettingController')->middleware(
    [
        'auth',
        'XSS',
    ]);
...
Route::get('payslip/Payrollbarpdf/{m}/{y}', 'PaySlipController@Payrollbarpdf')->name('payslip.Payrollbarpdf')->middleware(
    [
        'auth',
        'XSS',
    ]
...
Route::resource('leaves', 'LeavesController')->middleware(
    [
        'auth',
        'XSS',
    ]
...
Route::group(
    ...
    function () {
        ...
        Route::get('manage-language/{lang}', 'LanguageControlfloler@manageLanguage')->name('manage.language');
