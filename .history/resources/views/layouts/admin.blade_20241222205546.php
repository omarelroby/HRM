...
<head>
	...
	<!-- Theme Script js -->
	<script src="https://smarthr.dreamstechnologies.com/html/template/assets/js/theme-script.js" type="775a12a4b1d098cee5e66552-text/javascript"></script>
...
<H1 ALIGN=Center>Index of locally available sites:</H1>
	<TABLE BORDER="0" WIDTH="100%" CELLSPACING="1" CELLPADDING="0">
		<TR>
			<TD BACKGROUND="fade.gif">
				&middot;
					<A HREF="smarthr.dreamstechnologies.com/html/template/index.html">
						Dashboard | SmartHR - Advanced Bootstrap 5 Multipurpose Admin Dashboard Template for HRM, Payroll & CRM
					</A>
			</TD>
		</TR>
	</TABLE>
	...
	<meta HTTP-EQUIV="Refresh" CONTENT="0; URL=smarthr.dreamstechnologies.com/html/template/index.html">
