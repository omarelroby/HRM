...
<div class="card bg-none card-box">
    <div class="text-md-right mb-2">
        ...
        <a href="#" class="btn btn-xs rounded-pill btn-warning" onclick="saveAsPDF()">
            <span class="fa fa-download"></span>
        </a>
        <!-- Button to Send via Mail -->
        <a title="Mail Send" href="{{ route('payslip.send', [$employee->id, $payslip->salary_month]) }}" class="btn btn-xs rounded-pill btn-primary">
                ...
                <div class="col-lg-12">
                    <div class="invoice-title">
                        ...
                        <div class="invoice-number">
                            <img src="{{ $logo . '/' . (isset($company_logo) && !empty($company_logo) ? $company_logo : 'logo.png') }}" width="170px;" alt="Company Logo">
                        </div>
                    </div>
                    <hr>
