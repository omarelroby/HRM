...
<head>
	...
	<!-- Bootstrap CSS -->
	<link rel="stylesheet" href="{{ asset('assets/img/favicon.png') }}https://smarthr.dreamstechnologies.com/html/template/assets/css/bootstrap.min.css">

	<!-- Feather CSS -->
	<link rel="stylesheet" href="{{ asset('assets/img/favicon.png') }}https://smarthr.dreamstechnologies.com/html/template/assets/plugins/icons/feather/feather.css">

	<!-- Tabler Icon CSS -->
	<link rel="stylesheet" href="{{ asset('assets/img/favicon.png') }}https://smarthr.dreamstechnologies.com/html/template/assets/plugins/tabler-icons/tabler-icons.css">

	<!-- Fontawesome CSS -->
	<link rel="stylesheet" href="{{ asset('assets/img/favicon.png') }}https://smarthr.dreamstechnologies.com/html/template/assets/plugins/fontawesome/css/fontawesome.min.css">
	<link rel="stylesheet" href="{{ asset('assets/img/favicon.png') }}https://smarthr.dreamstechnologies.com/html/template/assets/plugins/fontawesome/css/all.min.css">

	<!-- Main CSS -->
	<link rel="stylesheet" href="{{ asset('assets/img/favicon.png') }}https://smarthr.dreamstechnologies.com/html/template/assets/css/style.css">
