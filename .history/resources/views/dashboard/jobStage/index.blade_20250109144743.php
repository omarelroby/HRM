                                ...
                                @foreach ($stages as $stage)
                                    <li class="list-group-item" data-id="{{$stage->id}}">
                                        ...
                                        <td class="text-right action-btns">
                                            @can('Edit Job Stage')
                                             <!-- Reply Button -->
                                             <a href="{{ route('company-policy.edit',$stage->id) }}"
                                             ...
                                             @endcan
                                              ...
                                              @can('Delete Job Stage')
                                              <form method="POST" action="{{ route('company-policy.destroy', $stage->id) }}" class="d-inline" onsubmit="return confirm('{{ __('Are You Sure?') }}\n{{ __('This action cannot be undone. Do you want to continue?') }}');">
                                                  @csrf
                                                  @method('DELETE')
