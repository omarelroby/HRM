                ...
                <div class="row">
                    ...
                    <div class="col-md-12 mb-3">
                        <div class="form-group">
                            ...
                            {{ Form::select('branch', $branches, null, ['class' => 'form-control select2' . ($errors->has('branch') ? ' is-invalid' : ''), 'required' => 'required']) }}
                            @error('branch')
                    ...
                    <div class="col-md-6 mb-3">
                        <div class="form-group">
                            ...
                            {{ Form::select('trainer_option', $options, null, ['class' => 'form-control select2' . ($errors->has('trainer_option') ? ' is-invalid' : ''), 'required' => 'required']) }}
                    ...
                    <div class="col-md-6 mb-3">
                        <div class="form-group">
                            ...
                            {{ Form::select('training_type', $trainingTypes, null, ['class' => 'form-control select2' . ($errors->has('training_type') ? ' is-invalid' : ''), 'required' => 'required']) }}
                            @error('training_type')
                                <div class="invalid-feedback d-block">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6 mb-3">
                        <div class="form-group">
                            ...
                            {{ Form::select('trainer', $trainers, null, ['class' => 'form-control select2' . ($errors->has('trainer') ? ' is-invalid' : ''), 'required' => 'required']) }}
                            @error('trainer')
                                <div class="invalid-feedback d-block">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6 mb-3">
                        <div class="form-group">
                            ...
                            {{ Form::number('training_cost', null, ['class' => 'form-control' . ($errors->has('training_cost') ? ' is-invalid' : ''), 'step' => '0.01', 'required' => 'required']) }}
                            @error('training_cost')
                                <div class="invalid-feedback d-block">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-12 mb-3">
                        <div class="form-group">
                            ...
                            {{ Form::select('employee', $employees, null, ['class' => 'form-control select2' . ($errors->has('employee') ? ' is-invalid' : ''), 'required' => 'required']) }}
                            @error('employee')
                                <div class="invalid-feedback d-block">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6 mb-3">
                        <div class="form-group">
                            ...
                            {{ Form::text('start_date', null, ['class' => 'form-control datetimepicker' . ($errors->has('start_date') ? ' is-invalid' : ''), 'required' => 'required']) }}
                            @error('start_date')
                                <div class="invalid-feedback d-block">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6 mb-3">
                        <div class="form-group">
                            ...
                            {{ Form::text('end_date', null, ['class' => 'form-control datetimepicker' . ($errors->has('end_date') ? ' is-invalid' : ''), 'required' => 'required']) }}
                            @error('end_date')
                                <div class="invalid-feedback d-block">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-12 mb-3">
                        <div class="form-group">
                            ...
                            {{ Form::textarea('description', null, ['class' => 'form-control' . ($errors->has('description') ? ' is-invalid' : ''), 'placeholder' => __('Description'), 'rows' => 3]) }}
                            @error('description')
                                <div class="invalid-feedback d-block">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-12 mb-3">
                        <div class="form-group">
                            ...
                            {{ Form::textarea('description_ar', null, ['class' => 'form-control' . ($errors->has('description_ar') ? ' is-invalid' : ''), 'placeholder' => __('Description (Arabic)'), 'rows' => 3]) }}
