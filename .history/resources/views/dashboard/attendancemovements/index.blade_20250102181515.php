                                ...
                                @foreach ($AttendanceMovements as $Attendancemovement)
                                    <tr>
                                        ...
                                        <td class="text-right">
                                            <!-- Edit Button -->
                                            @can('Edit Employee')
                                                <a href="{{ URL::to('attendancemovement/'.$Attendancemovement->id.'/edit') }}"
                                                   class="btn btn-success btn-icon-only"
                                                   data-url="{{ URL::to('attendancemovement/'.$Attendancemovement->id.'/edit') }}"
                                                   data-size="lg"
                                                   data-ajax-popup="true"
                                            ...
                                            @can('Delete Employee')
                                                <a href="#"
                                                   ...
                                                   onclick="if(confirm('{{ __('Are you sure? This action cannot be undone.') }}')) {
                                                                document.getElementById('delete-form-{{ $Attendancemovement->id }}').submit();
                                                            }">
                                                    <i class="fas fa-trash-alt"></i>
                                                </a>

                                                <!-- Form for Delete -->
                                                {!! Form::open(['method' => 'DELETE', 'route' => ['attendancemovement.destroy', $Attendancemovement->id], 'id' => 'delete-form-' . $Attendancemovement->id, 'style' => 'display:none;']) !!}
                                                {!! Form::close() !!}
                                            @endcan
                                        </td>
                                    </tr>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                {{Form::date('start_movement_date',null,array('class'=>'form-control datepicker'))}}
