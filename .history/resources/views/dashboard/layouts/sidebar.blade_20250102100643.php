                    ...
                    <ul>
                        ...
                        <li class="submenu">
                            ...
                            <ul style="display: none;">
                                ...
                                <li class="submenu">
                                    <a href="javascript:void(0);" class="subdrop {{ Request::is('jobtitle') || Request::is('nationality') || Request::is('labor_companies') || Request::is('workunits') || Request::is('employee_shifts') || Request::is('place') Request::is('jobtypes') || Request::is('place')   ?'active' :'' }}">
