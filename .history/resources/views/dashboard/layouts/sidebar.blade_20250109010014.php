            ...
            <ul>
                ...
                <li>
                    <ul>
                        ...
                        <li class="submenu">
                            <a href="javascript:void(0);" class="subdrop {{ Request::is('branch')  || Request::is('interview-schedule') || Request::is('custom-question') || Request::is('job-onboard')    ? 'active' : '' }}">
                            ...
                            <ul style="display: none;">
                                ...
                                <li><a class="{{ Request::is('department') ?'active' :'' }}" href="{{ route('department.index') }}">{{ __('Job') }}</a></li>
