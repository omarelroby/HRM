    ...
    <script src="{{ asset('public/assets/js/bootstrap-datetimepicker.min.js') }}https://smarthr.dreamstechnologies.com/html/template/assets/" type="text/javascript"></script>
