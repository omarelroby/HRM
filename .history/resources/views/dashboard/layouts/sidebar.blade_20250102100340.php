            ...
            <ul>
                ...
                <li>
                    <ul>
                        ...
                        <li class="submenu">
                            <a href="javascript:void(0);" class="subdrop {{ Request::is('employee_requests') || Request::is('attendanceemployee') || Request::is('attendanceemployee') ? 'active' : '' }}">
                            ...
                            <ul style="display: none;">
                                ...
                                <li class="submenu">
                                    ...
                                    <ul style="display: none;">
                                        <li><a class="{{ Request::is('employee_requests') ?'active' :'' }}" href="{{ route('attendanceemployee.index') }}">{{ __('Attendance History') }}</a></li>
                                        <li><a class="{{ Request::is('employee_requests') ?'active' :'' }}" href="{{ route('attendanceemployee.bulkattendance') }}">{{ __('Collective attendance') }}</a></li>
                                    </ul>
                                </li>
                            </ul>
                        </li>
