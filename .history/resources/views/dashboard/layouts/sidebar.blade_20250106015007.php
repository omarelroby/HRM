            ...
            <ul>
                ...
                <li>
                    <ul>
                        ...
                        <li class="submenu">
                            <a href="javascript:void(0);" class="subdrop {{ Request::is('job') || Request::is('job.application.candidate')  ? 'active' : '' }}">
                            ...
                            <ul style="display: none;">
                                ...
                                <li><a class="{{ Request::is('job-onboard') ?'active' :'' }}" href="{{ route('trainer.index') }}">{{ __('Job On Board') }}</a></li>
