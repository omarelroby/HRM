            ...
            <ul>
                ...
                <li>
                    <ul>
                        ...
                        <li class="submenu">
                            <a href="javascript:void(0);" class="subdrop {{ Request::is('job')  || Request::is('interview-schedule') || Request::is('custom-question') || Request::is('job-onboard')    ? 'active' : '' }}">
                                <i class="ti ti-shopping-bag"></i><span class="submenu-title">{{ __('constant') }}</span>
                                <span class="menu-arrow"></span>
                            </a>
                            <ul style="display: none;">
                                <li><a class="{{ Request::is('branch') ?'active' :'' }}" href="{{ route('branch.index') }}">{{ __('Job') }}</a></li>
                                <li><a class="{{ Request::is('bran') ?'active' :'' }}" href="{{ route('job.index') }}">{{ __('Job') }}</a></li>
