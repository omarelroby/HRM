            ...
            <ul>
                ...
                <li>
                    <ul>
                        ...
                        <li class="submenu">
                            <a href="javascript:void(0);" class="subdrop {{ Request::is('report/monthly/attendance')  || Request::is('report/leave')  Request::is('job-onboard') || Request::is('job.application.candidate')  ? 'active' : '' }}">
                                <i class="ti ti-shopping-bag"></i><span class="submenu-title">{{ __('Recruitment') }}</span>
                                <span class="menu-arrow"></span>
                            </a>
                            <ul style="display: none;">
