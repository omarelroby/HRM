                ...
                <li>
                    <ul>
                        ...
                        <li class="submenu">
                            ...
                            <ul style="display: none;">
                                <li><a class="{{ Request::is('goaltracking') ?'active' :'' }}" href="{{ route('indicator.index') }}">{{ __('indicators') }}</a></li>
                                <li><a class="{{ Request::is('goaltracking') ?'active' :'' }}" href="{{ route('appraisal.index') }}">{{ __('Appraisals') }}</a></li>
