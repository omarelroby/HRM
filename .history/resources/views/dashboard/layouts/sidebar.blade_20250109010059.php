            ...
            <ul>
                ...
                <li>
                    <ul>
                        ...
                        <li class="submenu">
                            <a href="javascript:void(0);" class="subdrop {{ Request::is('branch')  || Request::is('Department') || Request::is('designation') ? 'active' : '' }}">
                            ...
                            <ul style="display: none;">
                                ...
                                <li><a class="{{ Request::is('document') ?'active' :'' }}" href="{{ route('designation.index') }}">{{ __('Designation') }}</a></li>
                             </ul>
                        </li>
