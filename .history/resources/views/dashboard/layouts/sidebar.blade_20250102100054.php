                ...
                <li>
                    <ul>
                        ...
                        <li class="submenu">
                            ...
                            <ul style="display: none;">
                                <li><a href="{{ route('salary_setting.index') }}"  class="{{ Request::is('jobtitle') ?'banks' :'' }}">{{ __('Salary Data Settings') }}</a></li>
                                <li><a href="{{ route('setsalary.index') }}"  class="{{ Request::is('jobtitle') ?'banks' :'' }}">{{ __('Determine Salary') }}</a></li>
                            </ul>
                        </li>
