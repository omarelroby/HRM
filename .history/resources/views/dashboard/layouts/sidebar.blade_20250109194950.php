...
<style>
    ...
    .sidebar-logo-container {
        ...
        border-bottom: 1px solid #e0e0e0; /* Optional: Add a border */
    }
    ...
    .logo-img-dark {
        width: 200px; /* Adjust as needed */
        height: auto; /* Maintain aspect ratio */
        filter: brightness(0.8); /* Optional: Adjust for dark mode */
    }

    /* Sidebar Styling */
    .sidebar {
        margin-top: 0; /* Ensure no gap between logo and sidebar */
    }
</style>
@endsection
@php
