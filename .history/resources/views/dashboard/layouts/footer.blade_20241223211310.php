	...
	<!-- Custom JS -->
	<script src="{{ asset('assets/plugins/@simonwep/pickr/pickr.es5.min.js')}}https://smarthr.dreamstechnologies.com/html/template/assets/js/circle-progress.js" type="12789c3eb65f5dda020bae43-text/javascript"></script>
	<script src="{{ asset('assets/plugins/@simonwep/pickr/pickr.es5.min.js')}}https://smarthr.dreamstechnologies.com/html/template/assets/js/todo.js" type="12789c3eb65f5dda020bae43-text/javascript"></script>
