    ...
    <script src="{{ asset('public/assets/plugins/daterangepicker/daterangepicker.js') }}https://smarthr.dreamstechnologies.com/html/template/" type="text/javascript"></script>
