 <head>
	...
	<!-- Favicon -->
	<link rel="shortcut icon" type="image/x-icon" href="{{   asset('public/assets/css/bootstrap.min.css') }}https://smarthr.dreamstechnologies.com/html/template/assets/img/favicon.png">
