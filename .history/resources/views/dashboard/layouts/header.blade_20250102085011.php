 <head>
	...
	<!-- Select2 CSS -->
	<link rel="stylesheet" href="{{   asset('public/assets/plugins/tabler-icons/tabler-icons.css') }}https://smarthr.dreamstechnologies.com/html/template/assets/plugins/select2/css/select2.min.css">
	<!-- Fontawesome CSS -->
