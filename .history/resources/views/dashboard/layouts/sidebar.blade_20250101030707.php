                        ...
                        <ul>
                            ...
                            <li class="submenu">
                                ...
                                <ul style="display: none;"> <!-- Initially hidden -->
                                    ...
                                    <li class="submenu">
                                        <a href="javascript:void(0);" class="subdrop">
                                            <i class="ti ti-user-circle"></i><span>{{ __('Employee Setting') }}</span>
                                            <span class="menu-arrow"></span>
                                        </a>
                                        <ul style="display: none;"> <!-- Initially hidden -->
                                            <li><a href="{{ url('/jobtitle') }}">{{ __('Job Titles') }}</a></li>
                                            <li><a href="{{ url('/jobtitle') }}">{{ __('Nationality') }}</a></li>
                                         </ul>
                                    </li>
                                 </ul>
                            </li>
                            <li class="submenu">
                                <a href="javascript:void(0);" class="subdrop">
                                    <i class="ti ti-file-description"></i><span>{{ __('Payroll') }}</span>
                                    <span class="menu-arrow"></span>
                                </a>
                                <ul style="display: none;"> <!-- Initially hidden -->
                            ...
                            <li class="submenu">
                                <a href="javascript:void(0);" class="subdrop">
                                    <i class="ti ti-chart-line"></i><span>{{ __('Performance') }}</span>
                                    <span class="menu-arrow"></span>
                                </a>
                                <ul style="display: none;"> <!-- Initially hidden -->
                                    <li><a href="{{ route('indicator.index') }}">{{ __('Indicator') }}</a></li>
                                    <li><a href="{{ route('appraisal.index') }}">{{ __('appraisal') }}</a></li>
                                    <li><a href="{{ route('goaltracking.index') }}">{{ __('goaltracking') }}</a></li>
                                </ul>
                            </li>
                            <li class="submenu">
                                <a href="javascript:void(0);" class="subdrop">
                                    <i class="ti ti-clock"></i><span>{{ __('Time statement') }}</span>
                                    <span class="menu-arrow"></span>
                                </a>
                                <ul style="display: none;"> <!-- Initially hidden -->
