                    ...
                    <li>
                        <ul>
                            ...
                            <li class="submenu">
                                ...
                                <ul style="display: none;"> <!-- Initially hidden -->
                                    <li><a href="{{ route('salary_setting.index') }}">{{ __('Employee Request Management') }}</a></li>
                                    <li class="submenu">
                                        <a href="javascript:void(0);" class="subdrop">
                                        ...
                                        <ul style="display: none;"> <!-- Initially hidden -->
                                            <li><a href="{{ route('salary_setting.index') }}">{{ __('Attendance that was taught') }}</a></li>
                                            <li><a href="{{ route('salary_setting.index') }}">{{ __('Collective attendance') }}</a></li>
