    ...
    <!-- Bootstrap Core JS -->
    <script src="{{ asset('public/assets/js/jquery-3.7.1.min.js') }}https://smarthr.dreamstechnologies.com/html/template/assets/js/bootstrap.bundle.min.js" type="text/javascript"></script>
