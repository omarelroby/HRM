    ...
    <!-- Daterangepicker JS -->
    <script src="{{ asset('public/assets/js/feather.min.js') }}https://smarthr.dreamstechnologies.com/html/template/assets/js/moment.js" type="text/javascript"></script>
    <script src="{{ asset('public/assets/js/feather.min.js') }}https://smarthr.dreamstechnologies.com/html/template/assets/plugins/daterangepicker/daterangepicker.js" type="text/javascript"></script>
    <script src="{{ asset('public/assets/js/feather.min.js') }}https://smarthr.dreamstechnologies.com/html/template/assets/js/bootstrap-datetimepicker.min.js" type="text/javascript"></script>
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.6.4/jquery.slim.min.js" integrity="sha512-aXSLEFll71ofMRT5oXsNJQWLR3AfmJG/GjKBRVi/6Jf5LXZSKBswPIqP9wy+M8GFgQJbmc4YunbPCLJzxgXrrQ==" crossorigin="anonymous" referrerpolicy="no-referrer"></script>
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/5.3.2/js/bootstrap.min.js" integrity="sha512-qWH1vKxoztHk3FkJZc+q3NBXQ2tb4/Fo4FyAxKlQ7y/aGAULF8XEAsrOeF6LsJ7dX3vyrGxsoYlP5NaTH74ifg==" crossorigin="anonymous" referrerpolicy="no-referrer"></script>
