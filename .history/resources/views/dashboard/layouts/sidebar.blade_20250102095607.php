            ...
            <ul>
                ...
                <li>
                    <ul>
                        ...
                        <li class="submenu">
                            <a href="javascript:void(0);" class="subdrop {{ Request::is('employee') || Request::is('timesheet') || Request::is('payslip') || Request::is('jobtitle')||Request::is('nationality') || Request::is('timesheet') || Request::is('payslip') || Request::is('jobtitle') ? 'active' : '' }}">
