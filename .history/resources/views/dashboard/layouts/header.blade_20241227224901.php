 <head>
	...
	<!-- Datetimepicker CSS -->
	<link rel="stylesheet" href="{{ asset('public/assets/css/bootstrap-datetimepicker.css') }}https://smarthr.dreamstechnologies.com/html/template/assets/css/bootstrap-datetimepicker.min.css">
	<!-- Summernote CSS -->
	...
	<!-- Color Picker Css -->
	<link rel="stylesheet" href="{{  asset('public/assets/assets/plugins/flatpickr/flatpickr.min.css') }}">
    ...
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/datetimepicker@2.5.4/build/css/bootstrap-datetimepicker.min.css">
    <script src="https://cdn.jsdelivr.net/npm/datetimepicker@2.5.4/build/js/bootstrap-datetimepicker.min.js"></script>
</head>
