            ...
            <ul>
                ...
                <li>
                    <ul>
                        ...
                        <li class="submenu">
                            <a href="javascript:void(0);" class="subdrop {{ Request::is('employee')|| Request::is('holiday') || Request::is('timesheet')|| Request::is('request_types')  || Request::is('payslip') || Request::is('jobtitle')||Request::is('nationality') || Request::is('labor_companies') || Request::is('employee_shifts') || Request::is('place')|| Request::is('jobtypes') || Request::is('banks')  ? 'active' : '' }}">
                            ...
                            <ul style="display: none;">
                                ...
                                <li class="submenu">
                                    <a href="javascript:void(0);" class="subdrop {{ Request::is('jobtitle')|| Request::is('holiday') || Request::is('nationality')|| Request::is('request_types') || Request::is('labor_companies') || Request::is('workunits') || Request::is('employee_shifts') || Request::is('place')|| Request::is('jobtypes') || Request::is('banks') ?'active' :'' }}">
                                    ...
                                    <ul style="display: none;">
                                        ...
                                        <li><a href="{{ url('/salary_component_type') }}" class="{{ Request::is('salary_component_type') ?'active' :'' }}">{{ __('holiday') }}</a></li>
                                    </ul>
                                </li>
                            </ul>
                        </li>
