...
<script src="{{ asset('public/assets/plugins/bootstrap-tagsinput/bootstrap-tagsinput.js')}}" type="text/javascript"></script>
<script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/js/bootstrap.bundle.min.js"></script>
<script src="{{ asset('assets/plugins/bootstrap-tagsinput/bootstrap-hijri-datetimepicker.js') }}"></script>
<script src="{{ asset('assets/plugins/bootstrap-tagsinput/bootstrap-hijri-datepicker.js') }}"></script>
...
<!-- Hijri DatePicker JS -->
<script src="https://cdn.jsdelivr.net/npm/bootstrap4-hijri-datepicker/dist/js/bootstrap-hijri-datetimepicker.min.js"></script>
