                            ...
                            <ul style="display: none;">
                                ...
                                <li class="submenu">
                                    ...
                                    <ul style="display: none;">
                                        ...
                                        <li><a href="{{ url('/labor_companies') }}" class="{{ Request::is('jobtitle') ?'active' :'' }}">{{ __('labor_companies') }}</a></li>
                                        <li><a href="{{ url('/workunits') }}" class="{{ Request::is('jobtitle') ?'active' :'' }}">{{ __('workunits') }}</a></li>
                                        <li><a href="{{ url('/employee_shifts') }}" class="{{ Request::is('jobtitle') ?'active' :'' }}">{{ __('employee_shifts') }}</a></li>
                                        <li><a href="{{ url('/place') }}" class="{{ Request::is('jobtitle') ?'active' :'' }}">{{ __('location') }}</a></li>
                                        <li><a href="{{ url('/jobtypes') }}" class="{{ Request::is('jobtitle') ?'active' :'' }}">{{ __('job_type') }}</a></li>
                                        <li><a href="{{ url('/banks') }}" class="{{ Request::is('jobtitle') ?'active' :'' }}">{{ __('banks') }}</a></li>
                                    </ul>
                                </li>
                            </ul>
                        </li>
