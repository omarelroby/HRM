 <head>
	...
	<!-- Apple Touch Icon -->
	<link rel="apple-touch-icon" sizes="180x180" href="{{   asset('public/assets/img/favicon.png') }}https://smarthr.dreamstechnologies.com/html/template/assets/img/apple-touch-icon.png">
