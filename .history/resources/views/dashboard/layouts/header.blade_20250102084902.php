 <head>
	...
	<!-- Theme Script js -->
	<script src="{{ asset('public/assets/ }}https://smarthr.dreamstechnologies.com/html/template/assets/js/theme-script.js" type="8839293e20295dfe9c85554d-text/javascript"></script>
	<!-- Feather CSS -->
