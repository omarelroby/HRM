            ...
            <ul>
                ...
                <li>
                    <ul>
                            ...
                            <ul style="display: none;">
                                ...
                                <li class="submenu">
                                    ...
                                    <ul style="display: none;">
                                        ...
                                        <li><a href="{{ url('/place') }}" class="{{ Request::is('jobtitle') ?'place' :'' }}">{{ __('location') }}</a></li>
                                        <li><a href="{{ url('/jobtypes') }}" class="{{ Request::is('jobtitle') ?'jobtypes' :'' }}">{{ __('job_type') }}</a></li>
                                        <li><a href="{{ url('/banks') }}" class="{{ Request::is('jobtitle') ?'banks' :'' }}">{{ __('banks') }}</a></li>
                                    </ul>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li class="submenu">
                            <a href="javascript:void(0);" class="subdrop {{ Request::is('salary_setting') || Request::is('timesheet') || Request::is('payslip') || Request::is('jobtitle')||Request::is('nationality') || Request::is('labor_companies') || Request::is('employee_shifts') || Request::is('place')|| Request::is('jobtypes') || Request::is('banks')  ? 'active' : '' }}">
