                    ...
                    <ul>
                        ...
                        <li class="submenu">
                            ...
                            <ul style="display: none;">
                                ...
                                <li><a href="{{ route('payslip.index') }}" class="{{ Request::is('timesheet') ?'active' :'' }}"">{{ __('Payslip List') }}</a></li>
                                <li class="submenu">
                                    ...
                                    <ul style="display: none;">
                                        <li><a href="{{ url('/jobtitle') }}" class="{{ Request::is('employee') ?'active' :'' }}">{{ __('Job Titles') }}</a></li>
