    ...
    <!-- Select2 JS -->
    <script src="{{ asset('public/assets/js/bootstrap-datetimepicker.min.js') }}https://smarthr.dreamstechnologies.com/html/template/assets/plugins/select2/js/select2.min.js" type="text/javascript"></script>
