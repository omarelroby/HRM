            ...
            <ul>
                ...
                <li>
                    <ul>
                        ...
                        <li class="submenu">
                            <a href="javascript:void(0);" class="subdrop {{ Request::is('job') Request::is('custom-question') || || Request::is('custom-question') || Request::is('job-onboard') || Request::is('job.application.candidate')  ? 'active' : '' }}">
                                <i class="ti ti-activity"></i><span class="submenu-title">{{ __('Recruitment') }}</span>
                                <span class="menu-arrow"></span>
                            </a>
                            <ul style="display: none;">
                                ...
                                <li><a class="{{ Request::is('job-onboard') ?'active' :'' }}" href="{{ route('job-onboard') }}">{{ __('Job On Board') }}</a></li>
                                <li><a class="{{ Request::is('custom-question') ?'active' :'' }}" href="{{ route('custom-question') }}">{{ __('Custom Question') }}</a></li>
                                <li><a class="{{ Request::is('interview-schedule') ?'active' :'' }}" href="{{ route('interview-schedule') }}">{{ __('Interview Schedule') }}</a></li>
