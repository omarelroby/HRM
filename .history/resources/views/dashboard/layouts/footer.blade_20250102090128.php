    ...
    <!-- Chart JS -->
    <script src="{{ asset('public/assets/plugins/select2/js/select2.min.js') }}https://smarthr.dreamstechnologies.com/html/template/assets/plugins/apexchart/apexcharts.min.js" type="text/javascript"></script>
