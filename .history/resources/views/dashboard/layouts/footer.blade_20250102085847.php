    ...
    <!-- Feather Icon JS -->
    <script src="{{ asset('public/assets/js/bootstrap.bundle.min.js') }}https://smarthr.dreamstechnologies.com/html/template/assets/js/feather.min.js" type="text/javascript"></script>
