            ...
            <ul>
                ...
                <li>
                    <ul>
                        ...
                        <li class="submenu">
                            <a href="javascript:void(0);" class="subdrop {{ Request::is('job') || Request::is('trainer')  ? 'active' : '' }}">
                            ...
                            <ul style="display: none;">
                                ...
                                <li><a class="{{ Request::is('job-application/candidate') ?'active' :'' }}" href="{{ route('trainer.index') }}">{{ __('Job Application') }}</a></li>
                                <li><a class="{{ Request::is('trainer') ?'active' :'' }}" href="{{ route('trainer.index') }}">{{ __('Job On Board') }}</a></li>
                                <li><a class="{{ Request::is('trainer') ?'active' :'' }}" href="{{ route('trainer.index') }}">{{ __('Custom Question') }}</a></li>
                                <li><a class="{{ Request::is('trainer') ?'active' :'' }}" href="{{ route('trainer.index') }}">{{ __('Interview Schedule') }}</a></li>
