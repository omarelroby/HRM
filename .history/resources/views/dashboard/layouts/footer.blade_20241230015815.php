...
<script>
    ...
    $('.submenu > a').click(function(e){
        ...
        var $submenu = $(this).next('ul'); // Get the next 'ul' element

        // Toggle the 'ul' visibility
        if ($submenu.is(':visible')) {
            $submenu.slideUp();
            $(this).removeClass('subdrop'); // Optionally remove 'subdrop' class if you want to change the icon
        } else {
            $submenu.slideDown();
            $(this).addClass('subdrop'); // Optionally add 'subdrop' class if you want to change the icon
        }
    });
});
$(document).ready(function(){
    ...
    $('.submenu > a').click(function(e){
        ...
        if ($submenu.is(':visible')) {
            $submenu.slideUp(); // Slide up with 500ms duration
            $(this).removeClass('subdrop'); // Optionally remove the 'subdrop' class to change the icon
        } else {
            $submenu.slideDown(); // Slide down with 500ms duration
