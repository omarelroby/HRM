            ...
            <ul>
                ...
                <li>
                    <ul>
                        ...
                        <li class="submenu">
                            <a href="javascript:void(0);" class="subdrop {{ Request::is('training') || Request::is('attendanceemployee') || Request::is('attendanceemployee/bulkattendance') ? 'active' : '' }}">
                                <i class="ti ti-clock"></i><span class="submenu-title">{{ __('Training') }}</span>
                                <span class="menu-arrow"></span>
                            </a>
                            <ul style="display: none;">
                                <li><a class="{{ Request::is('training') ?'active' :'' }}" href="{{ route('employee_requests.index') }}">{{ __('Training') }}</a></li>
                                <li><a class="{{ Request::is('trainer') ?'active' :'' }}" href="{{ route('employee_requests.index') }}">{{ __('Training') }}</a></li>
