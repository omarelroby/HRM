...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        var departmentNames = @json($departments->keys()); // Get the department names (grouped keys)
        var employeeCounts = @json($departments->map(function($department) {
            return $department->sum('employeess_count'); // Sum employee counts for each department group
        }));
        ...
        var options = {
            ...
            xaxis: {
                ...
                tickAmount: 2, // Adjust the number of ticks (optional)
            }
        };
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        var employeeCounts = @json($departments->pluck('employeess_count')); // Use the employeess_count attribute
