...
<script>
    am5.ready(function() {
        ...
        var yRenderer = am5xy.AxisRendererY.new(root, {
          minGridDistance: 30, // Increase this value to add more space between rows
          minorGridEnabled: true,
          inversed: true, // Optional: Invert Y-axis if needed
          location: 1, // Move Y-axis to the right
          width: am5.percent(30) // Y-axis takes 30% of the chart width
        });

        yRenderer.grid.template.set("visible", false); // Hide grid lines if desired
        yRenderer.labels.template.set("fontSize", 12); // Adjust font size for Y-axis labels
...
var xRenderer = am5xy.AxisRendererX.new(root, {
  strokeOpacity: 0.1,
  minGridDistance: 80,
  width: am5.percent(0) // Set X-axis width to 0% of the chart width
});

xRenderer.labels.template.setAll({
  visible: false // Hide labels on the X-axis
});

xRenderer.grid.template.setAll({
  visible: false // Hide grid lines on the X-axis
});
