    ...
    <div class="all-button-box row d-flex justify-content-end">
        @can('Create Appraisal')
            <div class="col-xl-2 col-lg-2 col-md-4 col-sm-6 col-6">
                <a href="#" data-url="{{ route('appraisal.create') }}" class="btn btn-primary btn-icon-only width-auto" data-ajax-popup="true" data-title="{{__('Create New Appraisal')}}">
                                        ...
                                        <tr>
                                            ...
                                            @if( Gate::check('Edit Appraisal') ||Gate::check('Delete Appraisal') ||Gate::check('Show Appraisal'))
                                                <td class="text-right action-btns">
                                                    @can('Show Appraisal')
                                                        <a href="#" data-url="{{ route('appraisal.show',$appraisal->id) }}" data-size="lg" data-ajax-popup="true" data-title="{{__('Appraisal Detail')}}" data-toggle="tooltip" data-original-title="{{__('View Detail')}}" class="edit-icon btn btn-success bg-success"><i class="fa fa-eye"></i></a>
                                                    @endcan
                                                    @can('Edit Appraisal')
                                                        <a href="#" data-url="{{ route('appraisal.edit',$appraisal->id) }}" data-size="lg" data-ajax-popup="true" data-title="{{__('Edit Appraisal')}}" data-toggle="tooltip" data-original-title="{{__('Edit')}}" class="edit-icon btn btn-success"><i class="fa fa-edit"></i></a>
                                                    @endcan
                                                    @can('Delete Appraisal')
                                                        <a href="#" class="delete-icon btn btn-danger" data-confirm="{{__('Are You Sure?').'|'.__('This action can not be undone. Do you want to continue?')}}" data-toggle="tooltip" data-original-title="{{__('Delete')}}" data-confirm-yes="document.getElementById('delete-form-{{$appraisal->id}}').submit();"><i class="fa fa-trash"></i></a>
