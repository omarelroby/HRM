                                ...
                                @foreach ($assets as $asset)
                                    <tr>
                                        ...
                                        @if(Gate::check('Edit Assets') || Gate::check('Delete Assets'))
                                            ...
                                            <td>
                                                @can('Edit Assets')
                                                <a href="{{ route('assets.edit',$asset->id) }}" class="btn btn-sm btn-warning" data-toggle="tooltip" title="{{ __('Edit Assets') }}">
                                                    <i class="fas fa-edit"></i>
                                                </a>
                                                @endcan

                                            @can('Delete Assets')
                                                <form method="POST" action="{{ route('assets.destroy', $question->id) }}" class="d-inline" onsubmit="return confirm('{{ __('Are You Sure?') }}\n{{ __('This action cannot be undone. Do you want to continue?') }}');">
                                                    @csrf
                                                    @method('DELETE')
