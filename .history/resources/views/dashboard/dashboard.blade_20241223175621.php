...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        // Get department names and employee counts from Blade
        ...
        // Ensure the data exists and is valid before rendering the chart
        if (Array.isArray(departmentNames) && departmentNames.length > 0 &&
            Array.isArray(employeeCounts) && employeeCounts.length > 0) {
            ...
            console.error("Invalid data: Department names or employee counts are missing or empty.");
        }
    });
</script>
