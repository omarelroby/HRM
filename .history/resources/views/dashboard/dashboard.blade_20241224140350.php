...
<div class="tab-pane fade active show" id="applicants" role="tabpanel">
    @foreach ($applicants as $index => $applicant)
        <div class="d-flex align-items-center justify-content-between mb-4 {{ $index % 2 === 0 ? 'row-even' : 'row-odd' }}">
            <div class="d-flex align-items-center">
                <div class="ms-2 overflow-hidden">
                    <!-- Name Column -->
            ...
            <!-- Job Badge -->
            <span class="badge badge-xs text-white" style="background-color: #9467bd;">
