                                ...
                                @foreach ($competencies as $competency)
                                    <tr>
                                        ...
                                        <td class="text-right action-btns">
                                            @can('Edit Department')
                                             <!-- Reply Button -->
                                             <a href="{{ route('competencies.edit',$policy->id) }}"
                                             ...
                                             @endcan
                                              ...
                                              @can('Delete Department')
                                              <form method="POST" action="{{ route('competencies.destroy', $policy->id) }}" class="d-inline" onsubmit="return confirm('{{ __('Are You Sure?') }}\n{{ __('This action cannot be undone. Do you want to continue?') }}');">
                                                  @csrf
                                                  @method('DELETE')
