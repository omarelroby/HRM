    ...
    <div class="col-lg-12">
        <div class="tabs-container">
            ...
            <div class="col-lg-12 our-system">
                <div class="row">
                    <ul class="nav nav-tabs" role="tablist">
                        <li><a data-toggle="tab" class="nav-link active" href="#business-setting">{{__('Business Setting')}}</a></li>
                        <li><a data-toggle="tab" class="nav-link" href="#system-setting">{{__('System Setting')}}</a></li>
                        <li><a data-toggle="tab" class="nav-link" href="#company-setting">{{__('Company Setting')}}</a></li>
                        <li><a data-toggle="tab" class="nav-link" href="#email-setting">{{__('Email Notification Setting')}}</a></li>
                        <li><a data-toggle="tab" class="nav-link" href="#ip-restrict-setting">{{__('Ip Restrict Setting')}}</a></li>
                        <li><a data-toggle="tab" class="nav-link" href="#zoom-setting">{{__('Zoom Setting')}}</a></li>
                        <li><a data-toggle="tab" class="nav-link" href="#slack-setting">{{__('Slack Setting')}}</a></li>
                        <li><a data-toggle="tab" class="nav-link" href="#telegram-setting">{{__('Telegram Setting')}}</a></li>
                        <li><a data-toggle="tab" class="nav-link" href="#twilio-setting">{{__('Twilio Setting')}}</a></li>
                        <li><a class="nav-link" href="{{asset('manage-language/'.app()->getLocale())}}">{{__('Manage Language')}}</a></li>
                        <li><a data-toggle="tab" class="nav-link" href="#slate-setting">{{__('Company slate')}}</a></li>
                        <li><a data-toggle="tab" class="nav-link" href="#company-documents">{{__('Company Documents')}}</a></li>
                    </ul>
                </div>
            </div>
            ...
            <div class="tab-content">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-sm-6 col-md-6">
                            ...
                            <div class="card setting-card setting-logo-box">
                                ...
                                <div class="col-lg-12 col-sm-12 col-md-12">
                                    <label for="metakeyword" class="form-control-label text-dark">{{__('Meta Keywords')}}</label>
                                    <textarea class="form-control" rows="4" cols="8" name="metakeyword" id="metakeyword" style="resize: vertical; height: 100px;">{{ isset($settings['metakeyword']) ? $settings['metakeyword'] : '' }}</textarea>
                                </div>

                                <div class="col-lg-12 col-sm-12 col-md-12">
                                    <label for="metadesc" class="form-control-label text-dark">{{__('Meta Description')}}</label>
                                    <textarea class="form-control" rows="4" cols="8" name="metadesc" id="metadesc" style="resize: vertical; height: 100px;">{{ isset($settings['metadesc']) ? $settings['metadesc'] : '' }}</textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-12 text-right">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <input type="submit" style="width:100%;" value="{{__('Save Change')}}" class="btn btn-primary radius-10px">
                                </div>
                                <div class="col-md-4"></div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card bg-none p-4">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="form-control-label text-dark">{{__('Currency Symbol Position')}}</label>
                                        <div class="row">
                        ...
                        <div class="card bg-none p-4">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-4">
                                    {{Form::label('commercial_registration_no', __('Commercial Registration No'), ['class' => 'form-control-label text-dark'])}}
                                    {{Form::text('commercial_registration_no', null, ['class' => 'form-control'])}}
                                ...
                                <!-- Tax Number -->
                                <div class="form-group col-md-4">
                                    {{Form::label('tax_number', __('Tax Number'), ['class' => 'form-control-label text-dark'])}}
                                ...
                                <!-- Insurance Number -->
                                <div class="form-group col-md-4">
                                    {{Form::label('insurance_number', __('Insurance Number'), ['class' => 'form-control-label text-dark'])}}
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    {{Form::text('company_start_time', null, ['class' => 'form-control timepicker_format'])}}
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    {{Form::text('company_end_time', null, ['class' => 'form-control timepicker_format'])}}
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    {{Form::text('company_grace_period', null, ['class' => 'form-control'])}}
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        {{Form::hidden('lat', $settings['lat'] ? $settings['lat'] : '24.7305650', ['class' => 'form-control', 'id' => 'lat'])}}
                                        {{Form::hidden('lon', $settings['lon'] ? $settings['lon'] : '46.6555170', ['class' => 'form-control', 'id' => 'lon'])}}
                ...
                <!-- Email Notification Setting Tab -->
                ...
                <div class="tab-pane fade" id="slack-setting" role="tabpanel">
                    ...
                    <div class="bg-white">
                        ...
                        <div class="row">
                            ...
                            <!-- Monthly Payslip Notification -->
                            <div class="col-md-4">
                                <ul class="list-group">
                                    <li class="list-group-item">
                                        <span>{{__('Monthly payslip create')}}</span>
                                        <div class="custom-control custom-switch float-right">
                                            {{Form::checkbox('monthly_payslip_notification', '1', isset($settings['monthly_payslip_notification']) && $settings['monthly_payslip_notification'] == '1' ? 'checked' : '', ['class' => 'custom-control-input', 'id' => 'monthly_payslip_notification'])}}
                                    ...
                                    <li class="list-group-item">
                                        ...
                                        <div class="custom-control custom-switch float-right">
                                            {{Form::checkbox('award_notificaation', '1', isset($settings['award_notificaation']) && $settings['award_notificaation'] == '1' ? 'checked' : '', ['class' => 'custom-control-input', 'id' => 'award_notificaation'])}}
                            ...
                            <div class="col-md-4">
                                <ul class="list-group">
                                    <li class="list-group-item">
                                        ...
                                        <div class="custom-control custom-switch float-right">
                                            {{Form::checkbox('Announcement_notification', '1', isset($settings['Announcement_notification']) && $settings['Announcement_notification'] == '1' ? 'checked' : '', ['class' => 'custom-control-input', 'id' => 'Announcement_notification'])}}
                                    ...
                                    <li class="list-group-item">
                                        ...
                                        <div class="custom-control custom-switch float-right">
                                            {{Form::checkbox('Holiday_notification', '1', isset($settings['Holiday_notification']) && $settings['Holiday_notification'] == '1' ? 'checked' : '', ['class' => 'custom-control-input', 'id' => 'Holiday_notification'])}}
                            ...
                            <div class="col-md-4">
                                <ul class="list-group">
                                    <li class="list-group-item">
                                        ...
                                        <div class="custom-control custom-switch float-right">
                                            {{Form::checkbox('meeting_notification', '1', isset($settings['meeting_notification']) && $settings['meeting_notification'] == '1' ? 'checked' : '', ['class' => 'custom-control-input', 'id' => 'meeting_notification'])}}
                                    ...
                                    <li class="list-group-item">
                                        ...
                                        <div class="custom-control custom-switch float-right">
                                            {{Form::checkbox('company_policy_notification', '1', isset($settings['company_policy_notification']) && $settings['company_policy_notification'] == '1' ? 'checked' : '', ['class' => 'custom-control-input', 'id' => 'company_policy_notification'])}}
                            ...
                            <div class="col-md-4">
                                <ul class="list-group">
                                    <li class="list-group-item">
                                        ...
                                        <div class="custom-control custom-switch float-right">
                                            {{Form::checkbox('ticket_notification', '1', isset($settings['ticket_notification']) && $settings['ticket_notification'] == '1' ? 'checked' : '', ['class' => 'custom-control-input', 'id' => 'ticket_notification'])}}
                            ...
                            <div class="col-md-4">
                                <ul class="list-group">
                                    <li class="list-group-item">
                                        ...
                                        <div class="custom-control custom-switch float-right">
                                            {{Form::checkbox('event_notification', '1', isset($settings['event_notification']) && $settings['event_notification'] == '1' ? 'checked' : '', ['class' => 'custom-control-input', 'id' => 'event_notification'])}}
                            ...
                            <div class="col-md-4">
                                <ul class="list-group">
                                    <li class="list-group-item">
                                        <span>{{__('Monthly payslip create')}}</span>
                                        <div class="custom-control custom-switch float-right">
                                            {{Form::checkbox('telegram_monthly_payslip_notification', '1', isset($settings['telegram_monthly_payslip_notification']) && $settings['telegram_monthly_payslip_notification'] == '1' ? 'checked' : '', ['class' => 'custom-control-input', 'id' => 'telegram_monthly_payslip_notification'])}}
                                    ...
                                    <li class="list-group-item">
                                        <span>{{__('Award create')}}</span>
                                        <div class="custom-control custom-switch float-right">
                                            {{Form::checkbox('telegram_award_notification', '1', isset($settings['telegram_award_notification']) && $settings['telegram_award_notification'] == '1' ? 'checked' : '', ['class' => 'custom-control-input', 'id' => 'telegram_award_notification'])}}
                            ...
                            <div class="col-md-4">
                                <ul class="list-group">
                                    <li class="list-group-item">
                                        <span>{{__('Announcement create')}}</span>
                                        <div class="custom-control custom-switch float-right">
                                            {{Form::checkbox('telegram_Announcement_notification', '1', isset($settings['telegram_Announcement_notification']) && $settings['telegram_Announcement_notification'] == '1' ? 'checked' : '', ['class' => 'custom-control-input', 'id' => 'telegram_Announcement_notification'])}}
                                    ...
                                    <li class="list-group-item">
                                        <span>{{__('Holidays create')}}</span>
                                        <div class="custom-control custom-switch float-right">
                                            {{Form::checkbox('telegram_Holiday_notification', '1', isset($settings['telegram_Holiday_notification']) && $settings['telegram_Holiday_notification'] == '1' ? 'checked' : '', ['class' => 'custom-control-input', 'id' => 'telegram_Holiday_notification'])}}
                            ...
                            <div class="col-md-4">
                                <ul class="list-group">
                                    <li class="list-group-item">
                                        <span>{{__('Meeting create')}}</span>
                                        <div class="custom-control custom-switch float-right">
                                            {{Form::checkbox('telegram_meeting_notification', '1', isset($settings['telegram_meeting_notification']) && $settings['telegram_meeting_notification'] == '1' ? 'checked' : '', ['class' => 'custom-control-input', 'id' => 'telegram_meeting_notification'])}}
                                    ...
                                    <li class="list-group-item">
                                        <span>{{__('Company policy create')}}</span>
                                        <div class="custom-control custom-switch float-right">
                                            {{Form::checkbox('telegram_company_policy_notification', '1', isset($settings['telegram_company_policy_notification']) && $settings['telegram_company_policy_notification'] == '1' ? 'checked' : '', ['class' => 'custom-control-input', 'id' => 'telegram_company_policy_notification'])}}
                            ...
                            <div class="col-md-4">
                                <ul class="list-group">
                                    <li class="list-group-item">
                                        <span>{{__('Ticket create')}}</span>
                                        <div class="custom-control custom-switch float-right">
                                            {{Form::checkbox('telegram_ticket_notification', '1', isset($settings['telegram_ticket_notification']) && $settings['telegram_ticket_notification'] == '1' ? 'checked' : '', ['class' => 'custom-control-input', 'id' => 'telegram_ticket_notification'])}}
                            ...
                            <div class="col-md-4">
                                <ul class="list-group">
                                    <li class="list-group-item">
                                        <span>{{__('Event create')}}</span>
                                        <div class="custom-control custom-switch float-right">
                                            {{Form::checkbox('telegram_event_notification', '1', isset($settings['telegram_event_notification']) && $settings['telegram_event_notification'] == '1' ? 'checked' : '', ['class' => 'custom-control-input', 'id' => 'telegram_event_notification'])}}
                    ...
                    <div class="card-body bg-white">
                        ...
                        <div class="row">
                            ...
                            <div class="card-body pd-0">
                                <div class="row">
                                    <div class="form-group col-md-4">
                                        {{Form::label('twilio_sid', __('Twilio SID'), ['class' => 'form-control-label'])}}
                            ...
                            <div class="col-md-4">
                                <ul class="list-group">
                                    <li class="list-group-item">
                                        ...
                                        <div class="custom-control custom-switch float-right">
                                            {{Form::checkbox('twilio_payslip_notification', '1', isset($settings['twilio_payslip_notification']) && $settings['twilio_payslip_notification'] == '1' ? 'checked' : '', ['class' => 'custom-control-input', 'id' => 'twilio_payslip_notification'])}}
                                    ...
                                    <li class="list-group-item">
                                        ...
                                        <div class="custom-control custom-switch float-right">
                                            {{Form::checkbox('twilio_leave_approve_notification', '1', isset($settings['twilio_leave_approve_notification']) && $settings['twilio_leave_approve_notification'] == '1' ? 'checked' : '', ['class' => 'custom-control-input', 'id' => 'twilio_leave_approve_notification'])}}
                            ...
                            <div class="col-md-4">
                                <ul class="list-group">
                                    <li class="list-group-item">
                                        <span>{{__('Award create')}}</span>
                                        <div class="custom-control custom-switch float-right">
                                            {{Form::checkbox('twilio_award_notification', '1', isset($settings['twilio_award_notification']) && $settings['twilio_award_notification'] == '1' ? 'checked' : '', ['class' => 'custom-control-input', 'id' => 'twilio_award_notification'])}}
                                    ...
                                    <li class="list-group-item">
                                        ...
                                        <div class="custom-control custom-switch float-right">
                                            {{Form::checkbox('twilio_trip_notification', '1', isset($settings['twilio_trip_notification']) && $settings['twilio_trip_notification'] == '1' ? 'checked' : '', ['class' => 'custom-control-input', 'id' => 'twilio_trip_notification'])}}
                            ...
                            <div class="col-md-4">
                                <ul class="list-group">
                                    <li class="list-group-item">
                                        <span>{{__('Announcement create')}}</span>
                                        <div class="custom-control custom-switch float-right">
                                            {{Form::checkbox('twilio_announcement_notification', '1', isset($settings['twilio_announcement_notification']) && $settings['twilio_announcement_notification'] == '1' ? 'checked' : '', ['class' => 'custom-control-input', 'id' => 'twilio_announcement_notification'])}}
                            ...
                            <div class="col-md-4">
                                <ul class="list-group">
                                    <li class="list-group-item">
                                        <span>{{__('Ticket create')}}</span>
                                        <div class="custom-control custom-switch float-right">
                                            {{Form::checkbox('twilio_ticket_notification', '1', isset($settings['twilio_ticket_notification']) && $settings['twilio_ticket_notification'] == '1' ? 'checked' : '', ['class' => 'custom-control-input', 'id' => 'twilio_ticket_notification'])}}
                            ...
                            <div class="col-md-4">
                                <ul class="list-group">
                                    <li class="list-group-item">
                                        <span>{{__('Event create')}}</span>
                                        <div class="custom-control custom-switch float-right">
                                            {{Form::checkbox('twilio_event_notification', '1', isset($settings['twilio_event_notification']) && $settings['twilio_event_notification'] == '1' ? 'checked' : '', ['class' => 'custom-control-input', 'id' => 'twilio_event_notification'])}}
