...
<!-- Chart code -->
<!-- Chart container with increased size -->
...
<script>
    am5.ready(function() {
        ...
        var chart = root.container.children.push(am5xy.XYChart.new(root, {
          ...
          wheelX: "none",
          wheelY: "none",
          paddingLeft: 40, // Add padding to ensure Y-axis labels are fully visible
          paddingRight: 20,
          paddingTop: 20,
          paddingBottom: 20
        }));
        ...
        var yRenderer = am5xy.AxisRendererY.new(root, {
          minGridDistance: 50, // Increase this value to add more space between rows
        ...
        var series = chart.series.push(am5xy.ColumnSeries.new(root, {
          ...
          columnWidth: am5.percent(50), // Adjust column width (50% of available space)
          columnGap: 10 // Add gap between columns (rows)
        }));
