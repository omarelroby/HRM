...
<script>
    am5.ready(function() {
        ...
        var chart = root.container.children.push(am5xy.XYChart.new(root, {
          ...
          paddingRight: 40 // Add padding to ensure Y-axis labels are fully visible
        }));
        ...
        var xAxis = chart.xAxes.push(am5xy.ValueAxis.new(root, {
          ...
          extraMin: 0.02, // Reduce extra space at the start of the X-axis
          extraMax: 0.02, // Reduce extra space at the end of the X-axis
