                        ...
                        <table class="table table-striped table-bordered table-hover dataTables">
                            ...
                            <tbody class="font-style">
                                @foreach ($goaltypes as $goaltype)
                                    <tr>
                                        <td>{{ $goaltype->name }}</td>
                                        <td>{{ $goaltype->name_ar }}</td>
                                        <td class="text-right action-btns">
                                            @can('Edit Goal Type')
                                             <!-- Reply Button -->
                                             <a href="{{ route('goaltype.edit',$goaltype->id) }}"
                                             ...
                                             @endcan
                                              ...
                                              <form method="POST" action="{{ route('goaltype.destroy', $goaltype->id) }}" class="d-inline" onsubmit="return confirm('{{ __('Are You Sure?') }}\n{{ __('This action cannot be undone. Do you want to continue?') }}');">
                                                  @csrf
                                                  @method('DELETE')
