                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered table-hover dataTables">
                            ...
                            <tbody class="font-style">
                                @foreach ($request_types as $resources/views/dashboard/jobtypes/index.blade.php resources/views/dashboard/jobtypes/edit.blade.php)
                                    <tr>
                                        <td>{{ $jobtype->name }}</td>
                                        ...
                                        <td class="text-right">
                                            <!-- Edit Button -->
                                            @can('Edit Employee')
                                                <a href="{{ URL::to('jobtypes/'.$jobtype->id.'/edit') }}"
                                                   class="btn btn-success btn-icon-only"
                                                   data-url="{{ URL::to('jobtypes/'.$jobtype->id.'/edit') }}"
                                                   data-size="lg"
                                                   data-ajax-popup="true"
