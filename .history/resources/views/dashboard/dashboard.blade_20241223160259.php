        ...
        <div class="card-header pb-2 d-flex align-items-center justify-content-between flex-wrap">
            ...
            <div class="dropdown mb-2">
                <a href="javascript:void(0);" class="btn btn-white border btn-sm d-inline-flex align-items-center" data-bs-toggle="dropdown">
                    <i class="ti ti-calendar me-1"></i><span id="selected-period">This Week</span>
                </a>
                <ul class="dropdown-menu dropdown-menu-end p-3">
                    <li>
                        <a href="javascript:void(0);" class="dropdown-item rounded-1 filter-period" data-period="month">This Month</a>
                    </li>
                    <li>
                        <a href="javascript:void(0);" class="dropdown-item rounded-1 filter-period" data-period="week">This Week</a>
                    </li>
                    <li>
                        <a href="javascript:void(0);" class="dropdown-item rounded-1 filter-period" data-period="last-week">Last Week</a>
                    </li>
                </ul>
            </div>
        </div>
...
<script>
    ...
    document.addEventListener("DOMContentLoaded", function () {
        // Prepare initial data dynamically from Blade
        ...
        function fetchDepartmentData(period = 'week') {
            fetch(`/get-department-data?period=${period}`)
                ...
                .then(data => {
                    ...
                    if (departmentNames.length === 0 || total_employees.length === 0) {
                    ...
                    // Update selected period in the dropdown
                    const selectedText = {
                        'month': 'This Month',
                        'week': 'This Week',
                        'last-week': 'Last Week'
                    };
                    document.getElementById("selected-period").textContent = selectedText[period] || "This Week";
                })
        ...
        document.querySelectorAll('.filter-period').forEach(item => {
            item.addEventListener('click', function () {
                const period = this.dataset.period; // Get the selected period
