                        ...
                        <div class="card-body">
                            <div>
                                ...
                                <div class="mb-3 p-2 border br-5">
                                    ...
                                    use Carbon\Carbon;
                                    $time = '09:02:00';
                                    $clock_in = Carbon::createFromFormat('H:i:s', $emp->clock_in)->format('h:i A');
                                    $clock_out = Carbon::createFromFormat('H:i:s', $emp->clock_out)->format('h:i A');
                                    @endphp
                                    <div class="d-flex align-items-center justify-content-between flex-wrap mt-2 border br-5 p-2 pb-0">
                                        <div>
                                            ...
                                            <h6 class="fs-13 fw-normal mb-2">{{ Carbon::createFromFormat('H:i:s', $emp->clock_in)->format('h:i A') ??'' }}  </h6>
                                        </div>
                                        <div>
                                            <p class="mb-1 d-inline-flex align-items-center"><i class="ti ti-circle-filled text-danger fs-5 me-1"></i>Clock Out</p>
                                            <h6 class="fs-13 fw-normal mb-2">{{ Carbon::createFromFormat('H:i:s', $emp->clock_out)->format('h:i A') ??'' }} </h6>
                                        </div>
                                        <div>
