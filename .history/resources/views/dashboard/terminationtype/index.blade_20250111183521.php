                            ...
                            <tbody class="font-style">
                                @foreach ($terminationtypes as $terminationtype)
                                    <tr>
                                        ...
                                        <td>{{ $terminationtype->name_ar }}</td>

                                        <td class="text-right action-btns">
                                            @can('Edit Termination Type')
                                             <!-- Reply Button -->
                                             <a href="{{ route('terminationtype.edit',$terminationtype->id) }}"
                                             ...
                                             @endcan
                                              ...
                                              <form method="POST" action="{{ route('terminationtype.destroy', $terminationtype->id) }}" class="d-inline" onsubmit="return confirm('{{ __('Are You Sure?') }}\n{{ __('This action cannot be undone. Do you want to continue?') }}');">
                                                  @csrf
                                                  @method('DELETE')
