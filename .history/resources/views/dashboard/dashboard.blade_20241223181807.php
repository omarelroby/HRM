...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        // Safely handle fallback values if data is not available
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        // Redirect to a specific URL after the page refresh
        window.location.href = "{{ route('your.route.name') }}"; // Replace 'your.route.name' with your desired route name
    });
</script>
