...
<div class="col-xxl-4 d-flex">
    <div class="card flex-fill">
        <div class="card-header pb-2 d-flex align-items-center justify-content-between flex-wrap">
            ...
            <a href="{{ route('job.list') }}" class="btn btn-light btn-md mb-2">View All</a>
        </div>
        <div class="card-body">
            <ul class="nav nav-tabs tab-style-1 nav-justified d-sm-flex d-block p-0 mb-4" role="tablist">
                <li class="nav-item" role="presentation">
                    <a class="nav-link fw-medium active" data-bs-toggle="tab" data-bs-target="#openings" href="#openings" aria-selected="true" role="tab">Openings</a>
                </li>
                <li class="nav-item" role="presentation">
                    <a class="nav-link fw-medium" data-bs-toggle="tab" data-bs-target="#applicants" href="#applicants" aria-selected="false" role="tab">Applicants</a>
                </li>
            </ul>
            <div class="tab-content">
                <!-- Openings Tab -->
                <div class="tab-pane fade active show" id="openings" role="tabpanel">
                    @foreach($jobs as $job)
                        <div class="d-flex align-items-center justify-content-between mb-4">
                            <div class="d-flex align-items-center">
                                <div class="ms-2 overflow-hidden">
                                    ...
                                    <span class="fs-12">Category: {{ $job->category }}</span>
                                </div>
                            </div>
                            <a href="javascript:void(0);" class="btn btn-light btn-sm p-0 btn-icon d-flex align-items-center justify-content-center">
                            ...
                            <div class="d-flex align-items-center">
                                <div class="ms-2 overflow-hidden">
                                    ...
                                    <span class="fs-13 d-inline-flex align-items-center">
                                        {{ $applicant->gender }} <i class="ti ti-circle-filled fs-4 mx-2 text-primary"></i>{{ $applicant->country }}
                                    </span>
                                </div>
                            </div>
                            <span class="badge badge-secondary badge-xs">Rating: {{ $applicant->rating }}</span>
                        </div>
                    @endforeach
                </div>
            </div>
