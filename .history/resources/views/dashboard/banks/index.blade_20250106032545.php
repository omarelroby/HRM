                                        ...
                                        <td class="text-right">
                                            ...
                                            @can('Edit Employee')
                                                <a href="{{ URL::to('banks/'.$bank->id.'/edit') }}"
                                                   ...
                                                   data-url="{{ URL::to('banks/'.$bank->id.'/edit') }}"
                                                   data-size="lg"
                                                   data-ajax-popup="true"
                                            ...
                                            @can('Delete Employee')
                                                ...
                                                <!-- Form for Delete -->
                                                {!! Form::open(['method' => 'DELETE', 'route' => ['banks.destroy', $bank->id], 'id' => 'delete-form-' . $bank->id, 'style' => 'display:none;']) !!}
                                                {!! Form::close() !!}
                                            @endcan
                                        </td>
                                    </tr>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="createNationalityModalLabel">{{__('create bank')}}</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    {{ Form::open(['url' => 'banks', 'method' => 'post']) }}
                    <div class="row">
                        <!-- Name Field -->
                        <div class="col-12">
