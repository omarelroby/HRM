        ...
        $.ajax({
            ...
            success: function (response) {
                if (response.role && response.permissions) {
                    ...
                    // Loop through each module and generate the row with actions
                    Object.keys(response.permissions).forEach(function (module) {
                        const actions = ['Manage', 'Create', 'Edit', 'Delete'];
                        let row = `<tr>
                            <td>${module}</td>`;

                        // Loop through each action (Manage, Create, Edit, Delete)
