            ...
            <form id="add_employee" method="post">
                ...
                <div class="contact-grids-tab">
                    <ul class="nav nav-underline" id="myTab" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="idenit-tab" data-bs-toggle="tab" data-bs-target="#identity" type="button" role="tab" aria-selected="false" tabindex="-1">تفاصيل الهوية</button>
                        </li>
                        <li class="nav-item" role="presentation">
