                        ...
                        <div class="modal-body pb-0">
                            <div class="row">
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <input type="text" class="form-control hijri-date-input" name="hijri_date">
                                </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
...
<script src="https://cdn.jsdelivr.net/npm/persian-datepicker@1.2.0/dist/js/persian-datepicker.min.js"></script>
   ...
   <script src="{{ asset('publice/assets/plugins/bootstrap-tagsinput/bootstrap-hijri-datepicker.js') }}"></script>
      <script>
