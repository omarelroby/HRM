...
<script>
    $(document).ready(function () {
        $('#add_employee').on('submit', function (e) {
            ...
            // Reset previous error states and messages
            $('#add_employee .is-invalid').removeClass('is-invalid');
            $('#add_employee .invalid-feedback').hide();

            $.ajax({
                url: '{{ route("employee.store") }}', // Your route for storing employee
                method: 'POST',
                data: formData,
                processData: false,
                contentType: false,
                ...
                success: function (response) {
                    ...
                    if (response.status === 'success') {
                        ...
                        $('#successModal .modal-body').text(response.message); // Inject success message
