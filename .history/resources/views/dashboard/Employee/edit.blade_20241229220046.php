                            ...
                            <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <textarea id="custom_field_corona" name="custom_field_corona" class="form-control">{{ $employee->emergency_contact_phone }}</textarea>
                                    </div>

                                    <div class="form-group col-md-6">
                                        <label for="custom_field_notes" class="form-control-label">{{ __('Notes') }}</label>
                                        <textarea id="custom_field_notes" name="custom_field_notes" class="form-control">{{ $employee->emergency_contact_phone }}</textarea>
                                    </div>
                                </div>
