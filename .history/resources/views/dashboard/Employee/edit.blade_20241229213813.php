                            ...
                            <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <input type="text" value="{{ $employee->place_of_issuance_of_ID_residence }}" class="form-control" value="{{ $employee->place_of_issuance_of_ID_residence }}" name="place_of_issuance_of_ID_residence" id="place_of_issuance_of_ID_residence">
                                    </div>
                                    <div class="form-group col-md-3">
