...
{{-- Add Employee Modal --}}
<div class="modal fade" id="add_employee" tabindex="-1" aria-labelledby="addEmployeeModalLabel" aria-hidden="true">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <select name="department" id="department" class="select select2-hidden-accessible">
