                    ...
                    <div class="tab-pane fade show active" id="basic-info" role="tabpanel" aria-labelledby="info-tab">
                        <div class="modal-body pb-0">
                            <div class="row">
                                ...
                                <div class="row">
                                    <h6 class="col-md-12 py-2">تفاصيل الهوية / الأقامة</h6>
                                    ...
                                    <div class="form-group col-md-3">
                                        <label for="residence_number" class="form-label">{{__('place of issuance of ID residence')}}</label>
                                    ...
                                    <div class="form-group col-md-3">
                                        <label for="hijri_date" class="form-label">{{ __('Join date hijri') }}</label>
                                        <input type="text" class="form-control   hijri-date-input" id="hijri_date" name="hijri_date">
                                    </div>
                                    <div class="form-group col-md-3">
                                        <label for="iqama_issuance_expirydate_gregorian" class="form-label">{{ __('iqama issuance expirydate gregorian') }}</label>
                                    ...
                                    <div class="form-group col-md-3">
                                        <label for="iqama_issuance_expirydate_Hijri" class="form-label">{{ __('iqama issuance expirydate Hijri') }}</label>
                                    ...
                                    <div class="form-group col-md-6">
                                        <label for="iqama_attachment" class="form-label">{{ __('iqama attachment') }}</label>
                                        <input type="file" class="form-control " id="iqama_attachment" name="iqama_attachment">
                                    </div>
                                  </div>
                                <div class="row">
                                    <h6 class="col-md-12 py-2">تفاصيل جواز السفر</h6>
                                    <div class="form-group col-md-3">
                                    ...
                                    <div class="form-group col-md-3">
                                        <label for="place_of_issuance_of_passport" class="form-label">{{__('place of issuance of passport')}}</label>
                                        <input type="text" class="form-control  " name="place_of_issuance_of_passport" id="place_of_issuance_of_passport">
                                    </div>
                                    <div class="form-group col-md-3">
                                        <label for="passport_issuance_expirydate_gregorian" class="form-label">{{ __('passport issuance expirydate gregorian') }}</label>
                                    ...
                                    <div class="form-group col-md-3">
                                        <label for="passport_issuance_date_gregorian" class="form-label">{{ __('passport issuance date gregorian') }}</label>
                                    ...
                                    <div class="form-group col-md-6">
                                        <label for="passport_attachment" class="form-label">{{ __('passport attachment') }}</label>
                                        <input type="file" class="form-control " id="passport_attachment" name="passport_attachment">
                                    </div>
                                  </div>
                                  <div class="row">
                                    <h6 class="col-md-12">العنوان في السعودية</h6>

                                    <div class="form-group col-md-3">
                                        <label for="building_number" class="form-control-label">{{ __('building number') }}</label>
                                        <input type="text" id="building_number" name="building_number" value="{{ old('building_number') }}" class="form-control">
                                    </div>

                                    <div class="form-group col-md-3">
                                        <label for="street_name" class="form-control-label">{{ __('Street name') }}</label>
                                    ...
                                    <div class="form-group col-md-3">
                                        <label for="postal_code" class="form-control-label">{{ __('postal code') }}</label>
