                            ...
                            <fieldset>
                                ...
                                <div class="row g-3">
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <input type="text" name="insurance_startdate" id="insurance_startdate" class="form-control datetimepicker" value="{{ $employee->insurance_startdate??'' }}" value="{{ old('insurance_startdate') ?? now() }}">
                                                </div>
