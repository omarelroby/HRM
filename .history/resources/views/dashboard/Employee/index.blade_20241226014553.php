                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3 ">
                                            ...
                                            <div class="pass-group">
                                                <input type="password" name="password_confirmation" required class="pass-inputs form-control">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label class="form-label">{{__('Do you want to register in the list of users')}}
                                            </label>

                                             <div class="form-check form-check-md form-switch">
                                             <input class="form-check-input" name="user_register" type="checkbox" role="switch" id="switch-md">
                                              </div>
                                        </div>
                                    </div>
    ...
    $.ajax({
        ...
        success: function (response) {
            if (response.status === 'success') {
                ...
                alert(response.message); // Replace with SweetAlert or Toast
                location.reload();
            }
        },
        error: function (xhr) {
            if (xhr.status === 422) {
                ...
                for (let key in errors) {
                    alert(errors[key][0]); // Replace with SweetAlert or Toast
                }
            } else {
                alert(xhr.responseJSON.message); // General error message
            }
        },
    });
});
