            ...
            <form id="add_employee" method="post">
                ...
                <div class="contact-grids-tab">
                    <ul class="nav nav-underline" id="myTab" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="salary-tab" data-bs-toggle="tab" data-bs-target="#salaryModal" type="button" role="tab" aria-selected="false" tabindex="-1">{{ __('Passport Details') }}</button>
                        </li>
                        <li class="nav-item" role="presentation">
                        ...
                        <div class="modal-body">
                            <fieldset>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            <label for="salary" class="form-label">{{ __('basic_salary') }}</label>
                                            <input type="text" name="salary" id="salary" class="form-control required" value="{{ old('salary') }}">
                                            <div class="wizard-form-error"></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12 d-none" id="bankDetails">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div id="IBAN_number_info" class="mb-3 d-none">
                                                ...
                                                <div id="salary_card_number_info" class="mb-3">
                                    ...
                                    <div class="row mt-4">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" name="insurance_startdate" id="insurance_startdate" class="form-control gregorian-date" value="{{ old('insurance_startdate') ?? now() }}">
                                        </div>
                                        <div class="col-md-4">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" name="availability_health_insurance_council" id="availability_health_insurance_council" class="form-control gregorian-date" value="{{ old('availability_health_insurance_council') ?? now() }}">
                                        </div>
                                        <div class="col-md-4">
                                            <label for="health_insurance_council_startdate" class="form-label">{{ __('health_insurance_council_startdate') }}</label>
                                            <input type="text" name="health_insurance_council_startdate" id="health_insurance_council_startdate" class="form-control gregorian-date" value="{{ old('health_insurance_council_startdate') ?? now() }}">
                                        </div>
                                        <div class="col-md-4">
