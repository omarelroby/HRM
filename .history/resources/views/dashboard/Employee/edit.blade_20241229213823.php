                            ...
                            <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <input type="text" class="form-control datetimepicker" id="iqama_issuance_date_gregorian" value="{{ $employee->place_of_issuance_of_ID_residence }}" name="iqama_issuance_date_gregorian">
                                    </div>
                                    <div class="form-group col-md-3">
