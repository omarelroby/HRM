...
<div class="content">
    ...
    <div class="d-md-flex d-block align-items-center justify-content-between page-breadcrumb mb-3">
        <div class="my-auto mb-2">
            <h2 class="mb-1">{{ __('employee') }}</h2>
            <nav>
                <ol class="breadcrumb mb-0">
                <ol class="breadcrumb mb-0">
                    <li  >
                        <a href="{{ route('home') }}"><i class="ti ti-smart-home"></i>{{ __('Home') }}</a>
                    </li>
                </ol>
            </nav>
        </div>
        <div class="d-flex my-xl-auto right-content align-items-center flex-wrap ">
            ...
            <div class="mb-2">
                <a href="#" data-bs-toggle="modal" data-bs-target="#addEmployeeModal" class="btn btn-primary d-flex align-items-center"><i class="ti ti-circle-plus me-2"></i>{{ __('Add Employee') }}</a>
            </div>
                                ...
                                <tr class="odd">
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <!-- Complete Data Button (Conditional) -->
                                            @php
                                                $nullableColumns = [
                                                    'sync_attendance_employee_id', 'name_ar', 'dob', 'nationality_id', 'category_id', 'jobtitle_id',
                                                    'phone', 'address', 'email', 'personal_email', 'password', 'employee_id', 'branch_id', 'department_id',
                                                    'designation_id', 'company_doj', 'documents', 'account_holder_name', 'account_number', 'bank_name',
                                                    'bank_identifier_code', 'branch_location', 'tax_payer_id', 'salary_type', 'salary', 'expiry_date',
                                                    ...
                                                    'payment_type', 'employee_account_type', 'bank_IBAN_number', 'salary_card_number', 'bank_id', 'IBAN_number',
                                                    'account_holder_name_ar', 'branch_location_ar', 'swift_code', 'sort_code', 'bank_country', 'policy_number',
...
<tr class="odd">
    ...
    <td>
        <div class="d-flex align-items-center">
            ...
            @else
                <!-- Show "Edit" button if all columns are complete -->
                <a href="{{ route('employee.edit', $employee->id) }}" class="btn btn-sm btn-primary me-2" title="d">
                    <i class="fas fa-edit"></i>
                </a>
            @endif
