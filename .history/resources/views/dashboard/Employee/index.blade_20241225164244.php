                ...
                <div class="row dt-row">
                    ...
                    <thead class="thead-light">
                        <tr>
                            ...
                            <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Emp ID: activate to sort column ascending" style="width: 55.5341px;">ID</th>
                            ...
                            <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Phone: activate to sort column ascending" style="width: 95.2045px;">Job Title</th>
                    ...
                    <tbody>
                        ...
                        <tr class="odd">
                            ...
                            <td><a href="employee-details.html">{{ $employee->name }}</a></td>
                            <td>
