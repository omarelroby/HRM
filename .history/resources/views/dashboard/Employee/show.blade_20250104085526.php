                            ...
                            <div class="text-center px-3 pb-3 border-bottom">
                                ...
                                <div>
                                    <div class="d-flex align-items-center justify-content-between mb-2">
                                        ...
                                        <p class="text-dark">{{ \Auth::user()->employeeIdFormat($employee->employee_id) }} - {{$employee->id}}  </p>
                                    </div>
                                    <div class="d-flex align-items-center justify-content-between mb-2">
                                        <span class="d-inline-flex align-items-center">
                                    ...
                                    <div class="row gx-2 mt-3">
                                        <div class="col-6">
                                            <div>
                                                <a href="{{ route('employee.edit',#) }}" class="btn btn-dark w-100" target="_blank"><i class="ti ti-edit me-1"></i>Edit Info</a>
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <div>
