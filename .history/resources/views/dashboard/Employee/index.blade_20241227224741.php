                            ...
                            <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <!-- Add both 'datetimepicker' and 'hijri-date-input' classes -->
                                        <input type="text" class="form-control datetimepicker hijri-date-input" id="hijri_date" name="hijri_date">
                                    </div>
                                </div>
                                <div class="col-md-6">
...
<script src="https://cdn.jsdelivr.net/npm/persian-datepicker@1.2.0/dist/js/persian-datepicker.min.js"></script>
   ...
   <script src="{{ asset('public/assets/plugins/bootstrap-tagsinput/bootstrap-hijri-datepicker.js') }}"></script>
    ...
    // Initialize the Hijri Datepicker for inputs with the 'datetimepicker' class
    $('.datetimepicker').hijriDatePicker({
        locale: "ar-sa",               // Arabic locale
        format: "DD-MM-YYYY",          // Gregorian format
        hijriFormat: "iYYYY-iMM-iDD",  // Hijri format
        showSwitcher: true,            // Hijri/Gregorian switcher
        allowInputToggle: true,        // Allow manual input
        showTodayButton: true,         // Display "Today" button
        showClear: true,               // Display "Clear" button
        showClose: true,               // Display "Close" button
        debug: true,                   // Enable debugging
        isRTL: true,                   // Enable right-to-left layout
        hijri: true                    // Default to Hijri calendar
    });
});
