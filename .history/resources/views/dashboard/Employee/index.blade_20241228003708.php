                        ...
                        <div class="modal-body pb-0">
                            <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-3">
                                        <label for="passport_issuance_date_gregorian" class="form-label">{{ __('Join date hijri') }}</label>
                                        <input type="text" class="form-control   hijri-date-input" id="hijri_date" name="passport_issuance_date_gregorian">
                                    </div>
