                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-4">
                                        <div class="form-check mt-4">
                                            <input type="checkbox" class="form-check-input" id="uploading_record_permission" name="uploading_record_permission" value="1" {{ $employee->employee_on_probation   ? 'checked' : '' }}  >
