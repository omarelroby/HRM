                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" value="{{ $employee->name_en }}" name="name_ar" id="name_ar" class="form-control">
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="email" value="{{ $employee->name_en }}" name="email" id="email" class="form-control">
