                            ...
                            <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <input type="text" value="{{ $employee->hijri_date }}" class="form-control datetimepicker" id="Join_date_gregorian" name="hijri_date">
                                    </div>
                                    <div class="form-group col-md-3">
                                        <label for="hijri_date" class="form-label">{{ __('Join_date_hijri') }}</label>
                                        <input type="text" value="{{ $employee->hijri_date }}" class="form-control hijri-date-input" id="hijri_date" name="hijri_date">
                                    </div>
                                    <div class="form-group col-md-3">
