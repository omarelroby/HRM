                        ...
                        <div class="modal-body pb-0">
                            <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-3">
                                        <label for="iqama_issuance_expirydate_gregorian" class="form-label">{{ __('Join date gregorian') }}</label>
                                        <input type="text" class="form-control   datetimepicker" id="iqama_issuance_expirydate_gregorian" name="hijri_date">
                                    </div>
                                    <div class="form-group col-md-3">
                                        <label for="hijri_date" class="form-label">{{ __('Join date hijri') }}</label>
                                        <input type="text" class="form-control   hijri-date-input" id="iqama_issuance_expirydate_gregorian" name="iqama_issuance_expirydate_gregorian">
                                    </div>
