                        ...
                        <div class="modal-body">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <div class="d-flex">
                                        <div class="form-check me-2">
                                            <input class="form-check-input" type="radio" name="contract_duration" {{ $employee->contract_duration ? 'checked' : '' }} id="1year" value="1" checked>
                                            <label class="form-check-label" for="1year">{{ __('1year') }}</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="contract_duration" {{ $employee->contract_duration != 0 ? 'checked' : '' }} id="2year" value="2">
