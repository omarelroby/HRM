                    ...
                    <div class="tab-pane fade show active" id="basic-info" role="tabpanel" aria-labelledby="info-tab">
                        <div class="modal-body pb-0">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        <label for="personal_email" class="form-label">{{ __('Email') }} <span class="text-danger">*</span></label>
                                        <input type="email" value="{{ $employee->email }}" name="personal_email" id="personal_email" class="form-control">
                                        <div id="email_error" class="invalid-feedback"></div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3 text-center">
                                        ...
                                        <div class="form-check form-check-md form-switch d-flex justify-content-center">
                                            <!-- Hidden input for unchecked checkbox (defaults to 0) -->
                                            <input type="hidden" name="user_register" value="0">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <input type="text" id="building_number" name="building_number" value="{{ $employee->building_number }}" value="{{ old('building_number') }}" class="form-control">
                                    </div>

                                    <div class="form-group col-md-3">
                                        <label for="street_name" class="form-control-label">{{ __('Street_name') }}</label>
                                        <input type="text" id="street_name" value="{{ $employee->street_name }}" name="street_name" value="{{ old('street_name') }}" class="form-control">
                                    </div>

                                    <div class="form-group col-md-3">
                                        <label for="region" class="form-control-label">{{ __('Region') }}</label>
                                        <input type="text" id="region" value="{{ $employee->region }}" name="region" value="{{ old('region') }}" class="form-control">
                                    </div>

                                    <div class="form-group col-md-3">
                                        <label for="city" class="form-control-label">{{ __('City') }}</label>
                                        <input type="text" id="city" value="{{ $employee->city }}" name="city" value="{{ old('city') }}" class="form-control">
                                    </div>

                                    <div class="form-group col-md-3">
                                        <label for="country" class="form-control-label">{{ __('Country') }}</label>
                                        <input type="text" id="country" value="{{ $employee->country }}" name="country" value="{{ old('country') }}" class="form-control">
                                    </div>

                                    <div class="form-group col-md-3">
                                        <label for="postal_code" class="form-control-label">{{ __('Postal_code') }}</label>
                                        <input type="text" id="postal_code" value="{{ $employee->postal_code }}" name="postal_code" value="{{ old('postal_code') }}" class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" id="address" value="{{ $employee->address }}" name="address" value="{{ old('address') }}" class="form-control">
                                    </div>

                                    <div class="form-group col-md-3">
                                        <label for="mother_city" class="form-control-label">{{ __('City') }}</label>
                                        <input type="text" id="mother_city" value="{{ $employee->mother_city }}" name="mother_city" value="{{ old('mother_city') }}" class="form-control">
                                    </div>

                                    <div class="form-group col-md-3">
                                        <label for="mother_country" class="form-control-label">{{ __('Country') }}</label>
                                        <input type="text" id="mother_country" value="{{ $employee->mother_country }}" name="mother_country" value="{{ old('mother_country') }}" class="form-control">
                                    </div>
                                </div>
