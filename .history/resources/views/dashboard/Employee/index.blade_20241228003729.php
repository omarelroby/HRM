                        ...
                        <div class="modal-body pb-0">
                            <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6">
                                        <label for="passport_attachment" class="form-label">{{ __('iqama attachment') }}</label>
                                        <input type="file" class="form-control " id="iqama_attachment" name="passport_attachment">
                                    </div>
                                  </div>
