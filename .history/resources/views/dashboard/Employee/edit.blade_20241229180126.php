                                    ...
                                    <div class="mb-3" id="nationality">
                                        ...
                                        <select name="nationality_id" class="form-select required" aria-label="{{ __('Select Nationality') }}">
                                            ...
                                            @foreach($nationalities as $nationality)
                                                <option @if($nationality->id==$employee->nationality_id) selected @endif selected @endif value="{{ $nationality->id }}">{{ $nationality->name }}</option>
                                            @endforeach
                                        </select>
                                        <div class="wizard-form-error"></div>
                                    </div>
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <select name="gender" required id="gender" class="select select2-hidden-accessible">
                                            <option value="">{{ __('Select') }}</option>
                                            <option @if($employee->nationality_type==1) selected @endif  value="Male">{{ __('Male') }}</option>
