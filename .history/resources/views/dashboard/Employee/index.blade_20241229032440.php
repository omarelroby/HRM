...
<script>
    $(document).ready(function () {
        ...
        // Toggle Payment Type Details
        handlePaymentTypeToggle();

        // Handle Nationality Toggle
        handleNationalityToggle();

        // Handle Select All in DataTable
        handleSelectAll();
    ...
    function initializeDatePickers() {
        $('.datetimepicker').datetimepicker({
            format: 'DD/MM/YYYY',
            icons: { time: 'ti ti-time', date: 'ti ti-calendar', up: 'ti ti-chevron-up', down: 'ti ti-chevron-down' },
    ...
    function handleNationalityToggle() {
        $('#nationality_type').on('change', function () {
    ...
    function handleSelectAll() {
        $('#select-all').on('change', function () {
            ...
            $('.datatable tbody .form-check-input').prop('checked', isChecked);
        });
    }
            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response.status === 'success') {
                        ...
                        $('#successModal .modal-body').text(response.message).end().modal('show');
    ...
    function displayValidationErrors(errors) {
        $.each(errors, function (key, error) {
            const inputField = $(`#add_employee [name="${key}"]`);
