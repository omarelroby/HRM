                    ...
                    <div class="tab-pane fade show active" id="basic-info" role="tabpanel" aria-labelledby="info-tab">
                        <div class="modal-body pb-0">
                            <div class="row">
                                ...
                                <div class="form-group col-md-4">
                                    <label for="employer_phone" class="form-control-label">{{ __('employer_phone') }}</label>
                                    <input type="text" name="employer_phone" id="employer_phone" value="{{ old('employer_phone') }}" class="form-control">
                                </div>

                                <div class="form-group col-md-4">
                                    <label for="jobtitle_id" class="form-control-label">{{ __('jobtitle') }}</label>
                                    <select name="jobtitle_id" id="jobtitle_id" class="form-control">
                                        @foreach ($jobtitles as $key => $value)
                                            <option value="{{ $key }}" {{ old('jobtitle_id') == $key ? 'selected' : '' }}>{{ $value }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                     ...
                                     <div class="form-group col-md-3">
                                        <label for="residence_number" class="form-control-label">{{ __('residence_number') }}</label>
                                        <input type="text" name="residence_number" id="residence_number" value="{{ old('residence_number') }}" class="form-control">
                                    </div>

                                    <div class="form-group col-md-3">
                                        <label for="place_of_issuance_of_ID_residence" class="form-control-label">{{ __('place_of_issuance_of_ID_residence') }}</label>
                                        <input type="text" name="place_of_issuance_of_ID_residence" id="place_of_issuance_of_ID_residence" value="{{ old('place_of_issuance_of_ID_residence') }}" class="form-control">
                                    </div>

                                    <div class="form-group col-md-3">
                                        <label for="iqama_issuance_date_Hijri" class="form-control-label">{{ __('iqama_issuance_date_Hijri') }}</label>
                                        <input type="text" name="iqama_issuance_date_Hijri" id="hijri_4" value="{{ old('iqama_issuance_date_Hijri') ?? now() }}" class="form-control hijri-date-input">
                                    </div>

                                    <div class="form-group col-md-3">
                                        <label for="iqama_issuance_date_gregorian" class="form-control-label">{{ __('iqama_issuance_date_gregorian') }}</label>
                                        <input type="text" name="iqama_issuance_date_gregorian" id="gregorian_4" value="{{ old('iqama_issuance_date_gregorian') ?? now() }}" class="form-control gregorian-date">
                                    </div>

                                    <div class="form-group col-md-3">
                                        <label for="iqama_issuance_expirydate_Hijri" class="form-control-label">{{ __('iqama_issuance_expirydate_Hijri') }}</label>
                                        <input type="text" name="iqama_issuance_expirydate_Hijri" id="hijri_5" value="{{ old('iqama_issuance_expirydate_Hijri') ?? now() }}" class="form-control hijri-date-input">
                                    </div>

                                    <div class="form-group col-md-3">
                                        <label for="iqama_issuance_expirydate_gregorian" class="form-control-label">{{ __('iqama_issuance_expirydate_gregorian') }}</label>
                                        <input type="text" name="iqama_issuance_expirydate_gregorian" id="gregorian_5" value="{{ old('iqama_issuance_expirydate_gregorian') ?? now() }}" class="form-control gregorian-date">
                                    </div>

                                    <div class="form-group col-md-3">
                                        <label for="iqama_attachment" class="form-control-label">{{ __('add_attachment') }}</label>
                                        <input type="file" name="iqama_attachment" id="iqama_attachment" class="form-control">
                                    </div>
                                </div>
