                        ...
                        <div class="modal-body pb-0">
                            <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-3">
                                        <label for="place_of_issuance_of_passport" class="form-label">{{__('place of issuance of ID residence')}}</label>
                                        <input type="text" class="form-control  " name="place_of_issuance_of_passport" id="place_of_issuance_of_ID_residence">
                                    </div>
                                    <div class="form-group col-md-3">
                                        <label for="Join_date_gregorian" class="form-label">{{ __('Join date gregorian') }}</label>
                                        <input type="text" class="form-control   datetimepicker" id="Join_date_gregorian" name="hijri_date">
