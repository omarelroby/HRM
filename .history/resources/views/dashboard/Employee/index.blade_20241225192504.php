                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <div class="input-icon-end position-relative">
                                                <input type="text" name="dob" required class="form-control datetimepicker" placeholder="dd/mm/yyyy">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3 ">
                                            ...
                                            <div class="pass-group">
                                                <input type="password" required class="pass-input form-control">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3 ">
                                            ...
                                            <div class="pass-group">
                                                <input type="password" required class="pass-inputs form-control">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <span class="select2 select2-container select2-container--default" dir="ltr" data-select2-id="select2-data-2-q307" style="width: 100%;"><span class="selection"><span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-disabled="false" aria-labelledby="select2-tb38-container" aria-controls="select2-tb38-container"><span class="select2-selection__rendered" id="select2-tb38-container" role="textbox" aria-readonly="true" title="Select">Select</span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>
                                        </div>
                                    </div>
