        ...
        <div class="modal-content">
            ...
            <form id="add_employee" method="post">
                ...
                <div class="contact-grids-tab">
                    <ul class="nav nav-underline" id="myTab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button class="nav-link active" id="info-tab-edit" data-bs-toggle="tab" data-bs-target="#editEmployeeModal" type="button" role="tab" aria-selected="true">{{ __('Basic Information') }}</button>
                        </li>
                        <li class="nav-item" role="presentation">
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="info-tab-edit" data-bs-toggle="tab" data-bs-target="#address-edit" type="button" role="tab" aria-selected="false" tabindex="-1">{{ __('ID Details') }}</button>
                        </li>
                                ...
                                <form id="editEmployeeForm" method="POST" action="">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-control" id="editEmployeeStatus" name="is_active">
...
<script>
    $(document).ready(function () {
            ...
            $.ajax({
                ...
                method: 'GET',
                beforeSend: function () {
                    $('#editEmployeeModal').addClass('loading');
                },
                success: function (response) {
                    $('#editEmployeeModal #name').val(response.employee.name);
                    $('#editEmployeeModal #email').val(response.employee.email);
                    // Populate other fields dynamically
                },
                error: function (xhr) {
                    alert(`Failed to fetch employee data: ${xhr.statusText}`);
                },
                complete: function () {
                    $('#editEmployeeModal').removeClass('loading');
                },
            });
        });
