                            ...
                            <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <input type="text" class="form-control datetimepicker" id="Join_date_gregorian" name="Join_date_gregorian">
                                    </div>
                                    <div class="form-group col-md-3">
                                        <label for="Join_date_hijri" class="form-label">{{ __('Join_date_hijri') }}</label>
                                        <input type="text" class="form-control hijri-date-input" id="Join_date_hijri" name="Join_date_hijri">
                                    </div>
                                    <div class="form-group col-md-3">
