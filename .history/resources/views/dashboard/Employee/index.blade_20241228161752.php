                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <select class="form-control" name="work_unit" id="work_unit">
                                            @foreach($work_units as $id => $unit)
                                                <option value="{{ $work_units->id }}" {{ old('work_unit') == $id ? 'selected' : '' }}>{{ $work_units->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <select class="form-control" name="direct_manager" id="direct_manager">
                                            @foreach($employees as $id => $employee)
                                                <option value="{{ $id }}" {{ old('direct_manager') == $id ? 'selected' : '' }}>{{ $employee }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <select class="form-control" name="permission" id="permission">
                                            @foreach($roles as $id => $role)
                                                <option value="{{ $id }}" {{ old('permission') == $id ? 'selected' : '' }}>{{ $role }}</option>
                                            @endforeach
                                        </select>
                                    </div>
