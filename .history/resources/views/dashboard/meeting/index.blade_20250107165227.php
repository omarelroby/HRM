                            ...
                            @foreach ($meetings as $meeting)
                                <tr>
                                    ...
                                    <td class="text-right action-btns">
                                        ...
                                        @endcan
                                        @can('Edit Meeting')
                                        <a href="{{ route('meeting.edit', $training->id) }}"
                                    ...
                                    {{-- Delete Button --}}
                                    @can('Delete Training')
                                        {!! Form::open(['method' => 'DELETE', 'route' => ['training.destroy', $training->id], 'id' => 'delete-form-' . $training->id, 'style' => 'display:inline;']) !!}
                                            <button type="button" class="btn btn-danger btn-icon-only" data-toggle="tooltip" data-original-title="{{ __('Delete') }}"
                                                    onclick="if (confirm('Are you sure you want to delete this item? This action cannot be undone.')) { document.getElementById('delete-form-{{ $training->id }}').submit(); }">
                                                <i class="fa fa-trash"></i>
                                            </button>
                                        {!! Form::close() !!}
                                    @endcan
