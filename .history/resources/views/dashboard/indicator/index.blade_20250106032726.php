                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <div class="btn-group btn-group-sm" role="group">
                                        @can('Show Indicator')
                                        <a href="#" data-url="{{ route('indicator.show', $indicator->id) }}" class="btn btn-success btn-sm" data-ajax-popup="true" data-title="{{ __('Indicator Detail') }}" title="{{ __('View Detail') }}">
                                            <i class="fas fa-eye"></i> <!-- Small View Icon -->
                                        </a>
                                        @endcan

                                        @can('Edit Indicator')
                                        <a href="#" data-url="{{ route('indicator.edit', $indicator->id) }}" class="btn btn-primary btn-sm" data-ajax-popup="true" data-title="{{ __('Edit Indicator') }}" title="{{ __('Edit') }}">
                                            <i class="fas fa-pencil-alt"></i> <!-- Small Edit Icon -->
                                        </a>
                                        @endcan

                                        @can('Delete Indicator')
                                        <button type="button" class="btn btn-danger btn-sm" data-confirm="{{ __('Are You Sure?') . '|' . __('This action can not be undone. Do you want to continue?') }}" data-confirm-yes="document.getElementById('delete-form-{{ $indicator->id }}').submit();" title="{{ __('Delete') }}">
                                            <i class="fas fa-trash-alt"></i> <!-- Small Delete Icon -->
                                        </button>
