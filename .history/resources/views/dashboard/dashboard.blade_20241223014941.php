...
var options = {
    series: [{
      name: 'Modified Series Label', // Update series label
      data: [80, 110, 80, 20, 50]
    }],
    xaxis: {
      categories: ['Modified Jan', 'Feb', 'Mar', 'Apr', 'May'] // Update x-axis labels
    },
    tooltip: {
      y: {
        formatter: function(val) {
          return val + " modified units" // Update tooltip text
        }
      }
    }
  };
