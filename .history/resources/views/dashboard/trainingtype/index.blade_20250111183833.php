                                        ...
                                        <td class="text-right action-btns">
                                            @can('Edit Training Type')
                                             ...
                                             @endcan
                                              ...
                                              <form method="POST" action="{{ route('trainingtype.destroy', $trainingtype->id) }}" class="d-inline" onsubmit="return confirm('{{ __('Are You Sure?') }}\n{{ __('This action cannot be undone. Do you want to continue?') }}');">
                                                  @csrf
                                                  @method('DELETE')
