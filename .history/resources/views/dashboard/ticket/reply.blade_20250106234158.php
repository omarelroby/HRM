    ...
    <div class="all-button-box row d-flex justify-content-end">
        @if(\Auth::user()->type=='company' || $ticket->ticket_created == \Auth::user()->id)
            <div class="col-xl-2 col-lg-2 col-md-4 col-sm-6 col-6">
                <a href="#" data-url="{{ URL::to('ticket/'.$ticket->id.'/edit') }}" data-size="lg" data-ajax-popup="true" data-title="{{__('Edit Ticket')}}" class="btn btn-primary btn-icon-only width-auto"><i class="fa fa-edit"></i> <span>{{__('Edit')}}</span></a>
            </div>
        @endif
    </div>
@endsection
