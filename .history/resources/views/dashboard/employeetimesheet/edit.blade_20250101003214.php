                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <select id="employee_id" name="employee_id" class="form-select" required>
                                ...
                                @foreach($employees as $id => $name)
                                    <option @if($timeSheet->employees->id == $name->id) selected @endif value="{{ $name->id }}">{{ $name->name ??' '}}</option>
                                @endforeach
                            </select>
                        </div>
                        @endif
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <textarea id="remark" name="remark"   class="form-control" rows="2">{{ $timeSheet->remark }}</textarea>
                        </div>
