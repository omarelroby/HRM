...
@section('content')
    <div class="row">
        ...
        <div class="d-flex justify-content-end mb-3">
            @can('Create Employee')
                <a href="#" data-bs-toggle="modal" data-bs-target="#addTrainingModal" class="btn btn-outline-secondary btn-lg">
                                                ...
                                                <div class="btn-group" role="group">
                                                    @can('Show Trainer')
                                                        <a href="#" data-url="{{ route('trainer.show', $trainer->id) }}"
                                                            ...
                                                            data-title="{{ __('Trainer Details') }}" class="btn btn-sm btn-outline-info">
                                                    ...
                                                    @can('Edit Trainer')
                                                        <a href="#" data-url="{{ route('trainer.edit', $trainer->id) }}"
                                                            data-size="lg" data-ajax-popup="true"
                                                            data-title="{{ __('Edit Trainer') }}" class="btn btn-sm btn-outline-warning">
                                                            <i class="fas fa-edit"></i>
                                                        </a>
                                                    @endcan
                                                    @can('Delete Trainer')
                                                        <a href="#" class="btn btn-sm btn-outline-danger delete-trainer"
