                        ...
                        <tbody class="font-style">
                            @foreach ($jobOnBoards as $job)
                                <tr>
                                    ...
                                    <td>
                                    @can('Edit Job')
                                    <a href="{{route('job.on.board.edit', $job->id) }}" class="btn btn-primary btn-sm" data-toggle="tooltip" title="{{ __('Edit') }}"><i class="fa fa-edit"></i></a>
                                    @endcan
                                    @can('Delete Job')
                                    {!! Form::open(['method' => 'DELETE', 'route' => ['job.on.board.delete', $job->id], 'onsubmit' => 'return confirm("{{ __("Are You Sure?") }}\n{{ __("This action cannot be undone. Do you want to continue?") }}");']) !!}
                                        <button type="submit" class="btn btn-primary btn-sm" data-toggle="tooltip" title="{{ __('Delete') }}">
