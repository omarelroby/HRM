    ...
    <div class="d-flex justify-content-end mb-4">
        @can('Create Employee')
            <a href="#" data-bs-toggle="modal" data-bs-target="#addJobModal" class="btn btn-primary btn-lg">
                <i class="fas fa-plus me-2"></i> {{ __('Create Job') }}
            </a>
        @endcan
    </div>
                            ...
                            @foreach ($jobOnBoards as $job)
                                <tr>
                                    ...
                                    <td class="text-end">
                                        ...
                                        <a href="#" data-url="{{ route('job.on.board.edit', $job->id) }}" data-ajax-popup="true" class="btn btn-sm btn-warning" data-toggle="tooltip" title="{{ __('Edit') }}">
                                        ...
                                        {!! Form::open(['method' => 'DELETE', 'route' => ['job.on.board.delete', $job->id], 'id' => 'delete-form-' . $job->id, 'class' => 'd-none']) !!}
                                        {!! Form::close() !!}
                                    </td>
                                </tr>
                            @endforeach
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-header bg-primary text-white">
                <h5 class="modal-title" id="addJobModalLabel">{{ __('Add Job') }}</h5>
            ...
            <div class="modal-footer">
                <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal">{{ __('Cancel') }}</button>
