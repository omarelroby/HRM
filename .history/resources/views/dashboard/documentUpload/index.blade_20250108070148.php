                                            ...
                                            @if(Gate::check('Edit Document') || Gate::check('Delete Document'))
                                                <td class="text-end pe-4">
                                                    <div class="d-flex justify-content-end gap-2">
                                                        @can('Edit Document')
                                                            <a href="{{ route('document-upload.edit', $document->id) }}" data-url="" data-size="lg" data-ajax-popup="true" data-title="{{ __('Edit Document') }}" class="btn btn-sm btn-outline-success" data-toggle="tooltip" title="{{ __('Edit') }}">
