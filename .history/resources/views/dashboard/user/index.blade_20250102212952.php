                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="text-center mb-3">
                                ...
                                @if($user->is_active)
                                <p class="fs-10 fw-medium d-inline-flex align-items-center badge badge-success">
                                    <i class="ti ti-circle-filled fs-5 me-1">ACTIVE</i>
                                </p>
                                @else
                                <p class="fs-10 fw-medium d-inline-flex align-items-center badge badge-danger">
