        ...
        <div class="card-body">
          <div class="row">
            @foreach ($users as $user)
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-2">
                      ...
                      <div class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end">
                          ...
                          <li>
                            <a class="dropdown-item" href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#delete_modal_{{ $user->id }}">
              ...
              <div class="modal fade" id="delete_modal_{{ $user->id }}" tabindex="-1" aria-labelledby="deleteModalLabel" aria-hidden="true">
