              ...
              <div class="col-md-6 col-lg-4 col-xl-3 mb-4">
                <div class="card user-card">
                  <div class="card-body">
                    ...
                    <br />
                    @if($user->is_active)
                      <span class="fs-10 text-center fw-medium d-inline-flex align-items-center badge badge-success text-center">
                        <i class="ti ti-circle-filled fs-5 me-1">ACTIVE</i>
                      </span>
                    @else
                      <span class="fs-10 text-center fw-medium d-inline-flex align-items-center badge badge-danger text-center">
