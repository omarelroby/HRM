                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right">
                                            <div class="btn-group" role="group">
                                                @can('Edit Employee')
                                                    <a href="{{ URL::to('jobtitle/'.$jobtitle->id.'/edit') }}" class="btn btn-success btn-sm" data-url="{{ URL::to('jobtitle/'.$jobtitle->id.'/edit') }}" data-size="lg" data-ajax-popup="true" data-title="{{ __('Edit') }}" data-toggle="tooltip" data-original-title="{{ __('Edit') }}">
                                                ...
                                                <form action="{{ route('jobtitle.destroy', $jobtitle->id) }}" method="POST" style="display:inline;" onsubmit="return confirm('{{ __('Are you sure? This action cannot be undone.') }}');">
                                                    @method('DELETE')
                                                    @csrf
                                                    <button type="submit" class="btn btn-danger btn-sm" data-toggle="tooltip" data-original-title="{{ __('Delete') }}">
