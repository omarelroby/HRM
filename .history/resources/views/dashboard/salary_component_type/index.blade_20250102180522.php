        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h5>{{__('Employee Salary Component Type')}}</h5>
                </div>
                <div class="card-body">
                                ...
                                @foreach ($salary_components_types as $salary_components_type)
                                    <tr>
                                        ...
                                        <td class="text-right">
                                            <!-- Edit Button -->
                                            @can('Edit Employee')
                                                <a href="{{ URL::to('salary_component_type/'.$salary_components_type->id.'/edit') }}"
                                                   class="btn btn-success btn-icon-only"
                                                   data-url="{{ URL::to('salary_component_type/'.$salary_components_type->id.'/edit') }}"
                                                   data-size="lg"
                                                   data-ajax-popup="true"
                                            ...
                                            @can('Delete Employee')
                                                ...
                                                <!-- Form for Delete -->
                                                {!! Form::open(['method' => 'DELETE', 'route' => ['salary_component_type.destroy', $salary_components_type->id], 'id' => 'delete-form-' . $salary_components_type->id, 'style' => 'display:none;']) !!}
                                                {!! Form::close() !!}
                                            @endcan
                                        </td>
                                    </tr>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="createNationalityModalLabel">{{__('Employee Salary Component Type')}}</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    {{ Form::open(['url' => 'salary_component_type', 'method' => 'post']) }}
                    <div class="row">
                        <!-- Name Field -->
                        <div class="col-12">
