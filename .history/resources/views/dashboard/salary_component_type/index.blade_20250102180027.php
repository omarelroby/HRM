        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h5>{{__('Employee Request Type')}}</h5>
                </div>
                <div class="card-body">
                                ...
                                @foreach ($salary_components_types as $salary_components_type)
                                    <tr>
                                        ...
                                        <td class="text-right">
                                            <!-- Edit Button -->
                                            @can('Edit Employee')
                                                <a href="{{ URL::to('salary_components_types/'.$salary_components_type->id.'/edit') }}"
                                                   class="btn btn-success btn-icon-only"
                                                   data-url="{{ URL::to('salary_components_types/'.$salary_components_type->id.'/edit') }}"
                                                   data-size="lg"
                                                   data-ajax-popup="true"
                                                   data-title="{{ __('Edit salary_components_type') }}"
                                                   data-toggle="tooltip"
                                            ...
                                            @can('Delete Employee')
                                                ...
                                                <!-- Form for Delete -->
                                                {!! Form::open(['method' => 'DELETE', 'route' => ['request_types.destroy', $request_type->id], 'id' => 'delete-form-' . $request_type->id, 'style' => 'display:none;']) !!}
                                                {!! Form::close() !!}
                                            @endcan
                                        </td>
                                    </tr>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    {{ Form::open(['url' => 'request_types', 'method' => 'post']) }}
                    <div class="row">
                        <!-- Name Field -->
                        <div class="col-12">
