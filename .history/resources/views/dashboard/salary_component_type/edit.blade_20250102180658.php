        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h5>{{ __('Update Employee Salary_component_type') }}</h5>
                </div>
                <div class="card-body">

                {{Form::model($salary_component_type,array('route' => array('salary_component_type.update', $salary_component_type->id), 'method' => 'PUT')) }}
                <div class="row">
                    <div class="col-12">
