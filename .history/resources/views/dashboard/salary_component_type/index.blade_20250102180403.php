                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right">
                                            ...
                                            @can('Delete Employee')
                                                ...
                                                <!-- Form for Delete -->
                                                {!! Form::open(['method' => 'DELETE', 'route' => ['salary_components_types.destroy', $salary_components_type->id], 'id' => 'delete-form-' . $salary_components_types->id, 'style' => 'display:none;']) !!}
                                                {!! Form::close() !!}
                                            @endcan
                                        </td>
                                    </tr>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    {{ Form::open(['url' => 'salary_components_types', 'method' => 'post']) }}
                    <div class="row">
                        <!-- Name Field -->
                        <div class="col-12">
