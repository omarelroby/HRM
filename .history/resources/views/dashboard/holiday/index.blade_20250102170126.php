                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right">
                                            ...
                                            @can('Delete Employee')
                                                ...
                                                <!-- Form for Delete -->
                                                {!! Form::open(['method' => 'DELETE', 'route' => ['holidays.destroy', $holiday->id], 'id' => 'delete-form-' . $holiday->id, 'style' => 'display:none;']) !!}
                                                {!! Form::close() !!}
                                            @endcan
                                        </td>
                                        @endif
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    {{ Form::open(array('route' => array('holidays.index'),'method'=>'get','id'=>'holiday_filter')) }}
