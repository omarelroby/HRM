                        ...
                        <div class="d-flex align-items-center justify-content-between mb-4">
                            <div class="d-flex align-items-center">
                                <a href="#" class="avatar overflow-hidden flex-shrink-0 bg-gray-100">
                                    <img src="{{ asset('assets/img/icons/' . strtolower($job->title) . '.svg') }}" class="img-fluid rounded-circle w-auto h-auto" alt="{{ $job->title }}">
                                </a>
                            ...
                            <a href="{{ route('job.edit', $job->id) }}" class="btn btn-light btn-sm p-0 btn-icon"><i class="ti ti-edit"></i></a>
                        </div>
                    @endforeach
                </div>
                        ...
                        <div class="d-flex align-items-center justify-content-between mb-4">
                            <div class="d-flex align-items-center">
                                <a href="#" class="avatar overflow-hidden flex-shrink-0">
                                    <img src="{{ asset('assets/img/users/' . strtolower($applicant->profile)) }}" class="img-fluid rounded-circle" alt="{{ $applicant->name }}">
                                </a>
                                <div class="ms-2 overflow-hidden">
                                    <p class="text-dark fw-medium text-truncate mb-0"><a href="#">{{ $applicant->name }}</a></p>
                                    <span class="fs-13 d-inline-flex align-items-center">
                                        Exp: {{ $applicant->rating }}+ Years
                                        <i class="ti ti-circle-filled fs-4 mx-2 text-primary"></i>{{ $applicant->country }}
                                    </span>
                                </div>
                            </div>
                            <span class="badge badge-secondary badge-xs">{{ $applicant->jobRelation->title ?? 'Unknown' }}</span>
                        </div>
                    @endforeach
                </div>
            </div>
