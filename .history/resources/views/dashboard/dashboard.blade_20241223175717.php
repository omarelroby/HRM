...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        var departmentNames = @json($departmentNames ); // Get department names, default to empty array if not available
        var employeeCounts = @json($total_employees  ); // Get employee counts, default to empty array if not available
