...
yAxis.dataItems.each((dataItem, index) => {
    dataItem.get("renderer").grid.set("fill", am5.color(index % 2 === 0 ? "#f8864f" : "#ffffff"));
    dataItem.get("renderer").grid.set("fillOpacity", 0.1); // Optional transparency
});
