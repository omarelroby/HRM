                            ...
                            <tbody class="font-style">
                                @foreach ($performance_types as $performance_type)
                                    <tr>
                                        ...
                                        <td>{{ $performance_type->name_ar }}</td>
                                        ...
                                        <td class="text-right action-btns">
                                            @can('Edit Department')
                                             ...
                                             @endcan
                                              ...
                                              <form method="POST" action="{{ route('performanceType.destroy', $performance_type->id) }}" class="d-inline" onsubmit="return confirm('{{ __('Are You Sure?') }}\n{{ __('This action cannot be undone. Do you want to continue?') }}');">
                                                  @csrf
                                                  @method('DELETE')
