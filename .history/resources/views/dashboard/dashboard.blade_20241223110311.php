            ...
            <div class="col-md-3 d-flex">
                <div class="card flex-fill">
                    <div class="card-body">
                        ...
                        <h3 class="mb-3">{{ number_format($totalAttendedDays,3) .'/' .$totalWorkdaysSum }} <span class="fs-12 fw-medium text-success"><i class="fa-solid fa-caret-up me-1"></i>+2.1%</span></h3>
