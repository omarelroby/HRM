            ...
            <div class="col-md-6 d-flex">
                <div class="card flex-fill">
                    <div class="card-body">
                        ...
                        <h3 class="mb-3">{{ $complete_tasks .'/' .$employees }}<span class="fs-12 fw-medium text-success">
                            <i class="fa-solid fa-caret-down me-1"></i>{{ round($employeesWithAttendance/$employees * 100,2) }}%%</span></h3>
