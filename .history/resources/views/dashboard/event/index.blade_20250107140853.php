        ...
        $(document).ready(function () {
            ...
            if (calendarEl) {
                var calendar = new FullCalendar.Calendar(calendarEl, {
                    ...
                    events: {!! json_encode($arrEvents) !!}, // Load events
                    ...
                    eventDidMount: function (info) {
                        ...
                        console.log(info.event); // Debug event data
                    },
        ...
        if (calendarEl) {
            var calendar = new FullCalendar.Calendar(calendarEl, {
                ...
                events: function (fetchInfo, successCallback, failureCallback) {
                    ...
                    $.ajax({
                        url: '{{ route("event.fetch") }}', // Replace with your route
                        method: 'GET',
                        data: {
                        ...
                        success: function (response) {
                            successCallback(response.events); // Pass events to FullCalendar
                        },
                        error: function (xhr) {
                            failureCallback(xhr.responseJSON);
                        }
                    });
                }
            });
