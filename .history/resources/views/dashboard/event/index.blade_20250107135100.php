                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            {{ Form::text('title', null, ['class' => 'form-control', 'placeholder' => __('Enter Ticket Subject'), 'aria-label' => __('Subject')]) }}
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            {{ Form::text('title_ar', null, ['class' => 'form-control', 'placeholder' => __('Enter Ticket Subject in Arabic'), 'aria-label' => __('Subject (Arabic)')]) }}
                        </div>
                    </div>
                    ...
                    @if(\Auth::user()->type != 'employee')
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                {{ Form::select('employee_id', $employees, null, ['class' => 'form-control select2', 'placeholder' => __('Select Employee'), 'aria-label' => __('Select Employee')]) }}
                            </div>
                        </div>
                    @endif
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <select name="priority" class="form-control select2" aria-label="{{ __('Priority') }}">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            {{ Form::text('end_date', null, ['class' => 'form-control datepicker', 'aria-label' => __('End Date')]) }}
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            {{ Form::textarea('description', null, ['class' => 'form-control', 'placeholder' => __('Ticket Description'), 'aria-label' => __('Description'), 'rows' => 3]) }}
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            {{ Form::textarea('description_ar', null, ['class' => 'form-control', 'placeholder' => __('Ticket Description in Arabic'), 'aria-label' => __('Description (Arabic)'), 'rows' => 3]) }}
                        </div>
                    </div>
