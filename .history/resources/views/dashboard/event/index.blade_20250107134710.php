    ...
    <div class="button-container row justify-content-end my-3">
        @can('Create Event')
            <div class="col-xl-2 col-lg-2 col-md-4 col-sm-6 col-6">
                <a href="#" data-url="{{ route('event.create') }}" class="btn btn-primary btn-icon-only width-auto" data-ajax-popup="true" data-title="{{__('Create New Event')}}" aria-label="{{__('Create New Event')}}">
        ...
        <div class="d-flex justify-content-end mb-3">
            @can('Create Event')
                <a href="#" data-bs-toggle="modal" data-bs-target="#addTrainingModal" class="btn btn-primary btn-lg">
                    <i class="fas fa-plus"></i> {{ __('Create Event') }}
                </a>
            @endcan
        </div>
        <div class="col-xl-2 col-lg-2 col-md-4 col-sm-6 col-6">
            <a href="{{ route('event.export') }}" class="btn btn-primary btn-icon-only width-auto" aria-label="{{ __('Export Events') }}">
                <i class="fa fa-file-excel"></i> {{ __('Export') }}
            </a>
        </div>
        <div class="col-xl-2 col-lg-2 col-md-4 col-sm-6 col-6">
            <a href="#" class="btn btn-primary btn-icon-only width-auto" data-url="{{ route('event.file.import') }}" data-ajax-popup="true" data-title="{{ __('Import event CSV file') }}" aria-label="{{ __('Import Events') }}">
