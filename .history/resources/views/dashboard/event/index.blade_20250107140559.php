        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    {{ Form::open(['url' => 'event', 'method' => 'post', 'class' => 'needs-validation', 'novalidate' => true, 'id' => 'eventForm']) }}                    <div class="row g-3">
                        <!-- Branch Selection -->
                        <div class="col-md-12">
        ...
        $(document).ready(function () {
            var calendar = $('#event_calendar').fullCalendar({
                ...
                eventRender: function (event, element) {
                    // Custom event rendering (if needed)
                },
                eventAfterAllRender: function (view) {
                    // Called after all events are rendered
                }
            });
