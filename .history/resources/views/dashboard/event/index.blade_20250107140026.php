        ...
        $(document).ready(function () {
            ...
            if (calendarEl) {
                var calendar = new FullCalendar.Calendar(calendarEl, {
                    ...
                    selectHelper: true,
                    editable: true,
                    events: {!! json_encode($arrEvents) !!}, // Events data
                    ...
                    eventResize: function (info) {
                        ...
                        $.ajax({
                            url: info.event.extendedProps.resize_url,
                            method: 'PUT',
                            data: eventObj,
                            success: function (response) {
                                calendar.refetchEvents(); // Refresh events after resize
                            },
                            error: function (data) {
            ...
            // Department and Employee Dropdowns
