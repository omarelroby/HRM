                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right">
                                            <div class="btn-group" role="group">
                                                @can('Edit Branch')
                                                    <a href="{{ URL::to('place/'.$place->id.'/edit') }}"
                                                       class="btn btn-success btn-icon-only"
                                                       data-url="{{ URL::to('place/'.$place->id.'/edit') }}"
                                                       data-size="lg"
                                                ...
                                                @can('Delete Branch')
                                                    ...
                                                    <!-- Delete Form -->
                                                    {!! Form::open(['method' => 'DELETE', 'route' => ['place.destroy', $place->id], 'id' => 'delete-form-' . $place->id, 'style' => 'display:none;']) !!}
                                                    {!! Form::close() !!}
                                                @endcan
                                            </div>
                                        </td>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="createEmployeeShiftModalLabel">{{ __('Create New Location') }}</h5>
                </div>
