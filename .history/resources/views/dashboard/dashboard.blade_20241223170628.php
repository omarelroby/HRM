                            ...
                            <div>
                                ...
                                <div class="mb-3 p-2 border br-5">
                                    <div class="d-flex align-items-center justify-content-between">
                                        @php
                                        $clock_in_calc = date('h:i A', strtotime($emp->clock_in)); // Convert clock_in to h:i A format
                                        $clock_out_calc = date('h:i A', strtotime($emp->clock_out)); // Convert clock_out to h:i A format
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <span class="fs-10 fw-medium d-inline-flex align-items-center badge badge-success">
                                                <i class="ti ti-circle-filled fs-5 me-1"></i>{{ $$clock_out - $clock_in }}
                                            </span>
                                        </div>
                                    </div>
                                    @php
