        ...
        <div class="d-flex justify-content-end mb-3">
            @can('Create Job Category')
                <a href="#" data-bs-toggle="modal" data-bs-target="#addTrainingModal" class="btn btn-primary btn-lg">
                    <i class="fas fa-plus"></i> {{ __('Create New Job Category') }}
                </a>
            @endcan
        </div>
        <div class="col-lg-12">
                                        ...
                                        <td class="text-right action-btns">
                                            @can('Edit Job Category')
                                             ...
                                             @endcan
                                              ...
                                              <form method="POST" action="{{ route('category.destroy', $category->id) }}" class="d-inline" onsubmit="return confirm('{{ __('Are You Sure?') }}\n{{ __('This action cannot be undone. Do you want to continue?') }}');">
                                                  @csrf
                                                  @method('DELETE')
