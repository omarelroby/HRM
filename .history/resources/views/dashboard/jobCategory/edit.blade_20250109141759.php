...
@section('content')
        ...
        <div class="col-lg-12">
            <div class="card shadow-sm">
                ...
                <div class="card-header  text-white">
                    <h5 class="mb-0">{{ __('Update training type') }}</h5>
                </div>
                ...
                <div class="card-body">
                    ...
                    <div class="card bg-none card-box">
                        {{Form::model($jobCategory,array('route' => array('    {{Form::model($jobCategory,array('route' => array('job-category.update', $jobCategory->id), 'method' => 'PUT')) }}
    <div class="row">
        <div class="col-md-12">
    ...
    {{Form::close()}}
.update', $jobCategory->id), 'method' => 'PUT')) }}
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    {{Form::label('title',__('Title'),['class'=>'form-control-label'])}}
