            ...
            <div class="col-md-6 d-flex">
                <div class="card flex-fill">
                    <div class="card-body">
                        ...
                        <h6 class="fs-13 fw-medium text-default mb-1">Labor Hire</h6>
                        <h3 class="mb-3">{{ $labor_hiring }} <span class="fs-12 fw-medium text-danger"><i class="fa-solid fa-caret-down me-1"></i>-11.2%</span></h3>
