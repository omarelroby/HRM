...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        ->map(function ($group) {
            return [
                ...
                'department_count' => $group->count(), // Count how many times the department name exists
    ...
    $data['departmentCounts'] = $departments->pluck('department_count'); // Count of each department
    $data['employeeCounts'] = $departments->pluck('total_employees'); // Total employees for each department
