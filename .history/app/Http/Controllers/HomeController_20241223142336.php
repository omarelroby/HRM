...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        $employees = Employee::count(); // Get all employees
        $data['employeesWithAttendance'] = AttendanceEmployee::where('status', 'Present')->count(); // Employees present in the last 30 days
