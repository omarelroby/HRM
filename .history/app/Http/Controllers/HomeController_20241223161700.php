...
class HomeController extends Controller
{
    ...
    {
        // Fetch data based on the selected period (e.g., "This Week", "This Month")
        // Example logic
        $departments = Department::select('name')
            ->withCount(['employeess' => function ($query) use ($period) {
                if ($period === 'This Week') {
        ...
        $data = [
            ...
            'totalEmployees' => $departments->pluck('employeess_count'),
        ];
