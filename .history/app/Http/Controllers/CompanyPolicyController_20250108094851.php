...
c:\laragon\www\old-hrm\app\Http\Controllers\CompanyPolicyController.php
            return view('dashboard.companyPolicy.index', compact('companyPolicy'));
        } else {
...
c
    ...
    public function edit(CompanyPolicy $companyPolicy)
    {
        ...
        if (\Auth::user()->can('Edit Company Policy')) {
            ...
            return view('dashboard.companyPolicy.edit', compact('branch', 'companyPolicy'));
        } else {
            return response()->json(['error' => __('Permission denied.')], 401);
        }
    }
