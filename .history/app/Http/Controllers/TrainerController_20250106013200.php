...
class TrainerController extends Controller
{
    ...
    public function index()
    {
        if(\Auth::user()->can('Manage Trainer'))
        {
            ...
            return view('dashboard.trainer.index', compact('trainers','branches'));
        }
        else
        {
    ...
    public function store(Request $request)
    {
        if(\Auth::user()->can('Create Trainer'))
        {
            ...
            return redirect()->route('dtrainer.index')->with('success', __('Trainer  successfully created.'));
        }
        else
        {
            return redirect()->back()->with('error', __('Permission denied.'));
    ...
    public function edit(Trainer $trainer)
    {
        if(\Auth::user()->can('Edit Trainer'))
        {
            ...
            return view('dashboard.trainer.edit', compact('branches', 'trainer'));
        }
        else
        {
            return redirect()->back()->with('error', __('Permission denied.'));
